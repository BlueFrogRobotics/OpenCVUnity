...
using System;using System.Runtime.InteropServices;using System.Collections.Generic;namespace OpenCVUnity{
    public class Imgproc
    {
        ...
        /// <summary>Finds edges in an image using the [Canny86] algorithm.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image single-channel 8-bit input image.</param>
        /// <param>edges output edge map; it has the same size and type as
        /// <code>image</code>.</param>
        /// <param>threshold1 first threshold for the hysteresis procedure.</param>
        /// <param>threshold2 second threshold for the hysteresis procedure.</param>
        /// <param>apertureSize aperture size for the "Sobel" operator.</param>
        ...
        /// (<code>L2gradient=false</code>).</param>
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/feature_detection.html#canny">org.opencv.imgproc.Imgproc.Canny</a>
        public static void Canny(Mat image, Mat edges, double threshold1, double threshold2, int apertureSize, bool L2gradient)
        {
            ...
            opencvunity_imgproc_Imgproc_Canny_10(image.nativeObj, edges.nativeObj, threshold1, threshold2, apertureSize, L2gradient);
        }
        ...
        public static void Canny(Mat image, Mat edges, double threshold1, double threshold2)
        {
            ...
            opencvunity_imgproc_Imgproc_Canny_11(image.nativeObj, edges.nativeObj, threshold1, threshold2);
        }
        ...
        public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigmaX, double sigmaY, int borderType)
        {
            ...
            if (ksize.height % 2 == 0 || ksize.width % 2 == 0)
                throw new ArgumentException("GaussianBlur : kernel size must be odd");

            opencvunity_imgproc_Imgproc_GaussianBlur_10(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaX, sigmaY, borderType);
        ...
        /// processed independently, but the depth should be <code>CV_8U</code>,
        /// <code>CV_16U</code>, <code>CV_16S</code>, <code>CV_32F</code> or
        /// <code>CV_64F</code>.</param>
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>ksize Gaussian kernel size. <code>ksize.width</code> and
        /// <code>ksize.height</code> can differ but they both must be positive and odd.
        /// Or, they can be zero's and then they are computed from <code>sigma*</code>.</param>
        /// <param>sigmaX Gaussian kernel standard deviation in X direction.</param>
        ...
        public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigmaX, double sigmaY)
        {
            ...
            opencvunity_imgproc_Imgproc_GaussianBlur_11(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaX, sigmaY);
        }
        ...
        /// <param>src input image; the image can have any number of channels, which are
        /// processed independently, but the depth should be <code>CV_8U</code>,
        /// <code>CV_16U</code>, <code>CV_16S</code>, <code>CV_32F</code> or</param>
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>ksize Gaussian kernel size. <code>ksize.width</code> and
        /// <code>ksize.height</code> can differ but they both must be positive and odd.</param>
        ...
        public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigmaX)
        {
            ...
            opencvunity_imgproc_Imgproc_GaussianBlur_12(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaX);
        ...
        /// <summary>Finds circles in a grayscale image using the Hough transform.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image 8-bit, single-channel, grayscale input image.</param>
        /// <param>circles Output vector of found circles. Each vector is encoded as a</param>
        /// 3-element floating-point vector <em>(x, y, radius)</em>.
        /// <param>method Detection method to use. Currently, the only implemented method</param>
        /// is <code>CV_HOUGH_GRADIENT</code>, which is basically///21HT*, described in
        /// [Yuen90].
        /// <param>dp Inverse ratio of the accumulator resolution to the image</param>
        ...
        /// <param>minDist Minimum distance between the centers of the detected circles.</param>
        ...
        /// missed.
        /// <param>param1 First method-specific parameter. In case of <code>CV_HOUGH_GRADIENT</code>,</param>
        /// it is the higher threshold of the two passed to the "Canny" edge detector
        /// (the lower one is twice smaller).
        /// <param>param2 Second method-specific parameter. In case of <code>CV_HOUGH_GRADIENT</code>,</param>
        ...
        /// <param>minRadius Minimum circle radius.</param>
        /// <param>maxRadius Maximum circle radius.</param>
        ///
        ...
        public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1, double param2, int minRadius, int maxRadius)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughCircles_10(image.nativeObj, circles.nativeObj, method, dp, minDist, param1, param2, minRadius, maxRadius);
        ...
        /// 3-element floating-point vector <em>(x, y, radius)</em>.</param>
        ...
        public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughCircles_11(image.nativeObj, circles.nativeObj, method, dp, minDist);
        }
        ...
        /// <summary>Finds lines in a binary image using the standard Hough transform.</summary>
        ///
        ...
        /// pi/2 ~ horizontal line</em>).</param>
        /// <param>rho Distance resolution of the accumulator in pixels.</param>
        /// <param>theta Angle resolution of the accumulator in radians.</param>
        /// <param>threshold Accumulator threshold parameter. Only those lines are
        /// returned that get enough votes (<em>&gtthreshold</em>).</param>
        ...
        /// distance resolution <code>theta</code>.</param>
        ///
        ...
        public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold, double srn, double stn)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughLines_10(image.nativeObj, lines.nativeObj, rho, theta, threshold, srn, stn);
        }
        ...
        /// </ul>
        ///
        /// <param>image 8-bit, single-channel binary source image. The image may be</param>
        /// <param>lines Output vector of lines. Each line is represented by a
        /// two-element vector <em>(rho, theta)</em>. <em>rho</em> is the distance from
        /// the coordinate origin <em>(0,0)</em> (top-left corner of the image).
        /// <em>theta</em> is the line rotation angle in radians (<em>0 ~ vertical line,
        ...
        public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughLines_11(image.nativeObj, lines.nativeObj, rho, theta, threshold);
        }
        ...
        /// <summary>Finds line segments in a binary image using the probabilistic Hough
        /// transform.</p>
        ///
        ...
        /// <param>lines Output vector of lines. Each line is represented by a 4-element</param>
        /// vector <em>(x_1, y_1, x_2, y_2)</em>, where <em>(x_1,y_1)</em> and <em>(x_2,
        /// y_2)</em> are the ending points of each detected line segment.
        /// <param>rho Distance resolution of the accumulator in pixels.</param>
        /// <param>theta Angle resolution of the accumulator in radians.</param>
        /// <param>threshold Accumulator threshold parameter. Only those lines are</param>
        /// returned that get enough votes (<em>&gtthreshold</em>).
        /// <param>minLineLength Minimum line length. Line segments shorter than that are</param>
        /// rejected.
        /// <param>maxLineGap Maximum allowed gap between points on the same line to link</param>
        /// them.
        ///
        ...
        public static void HoughLinesP(Mat image, Mat lines, double rho, double theta, int threshold, double minLineLength, double maxLineGap)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughLinesP_10(image.nativeObj, lines.nativeObj, rho, theta, threshold, minLineLength, maxLineGap);
        }
        ...
        /// vector <em>(x_1, y_1, x_2, y_2)</em>, where <em>(x_1,y_1)</em> and <em>(x_2,
        /// y_2)</em> are the ending points of each detected line segment.</param>
        /// <param>rho Distance resolution of the accumulator in pixels.</param>
        /// <param>theta Angle resolution of the accumulator in radians.</param>
        /// <param>threshold Accumulator threshold parameter. Only those lines are
        /// returned that get enough votes (<em>&gtthreshold</em>).
        ...
        public static void HoughLinesP(Mat image, Mat lines, double rho, double theta, int threshold)
        {
            ...
            opencvunity_imgproc_Imgproc_HoughLinesP_11(image.nativeObj, lines.nativeObj, rho, theta, threshold);
        }
        ...
        /// <summary>Calculates seven Hu invariants.</summary>
        ///
        ...
        public static void HuMoments(Moments m, Mat hu)
        {
            ...
            opencvunity_imgproc_Imgproc_HuMoments_10(m.nativeObj, hu.nativeObj);
        ...
        /// <summary>Calculates the Laplacian of an image.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>src Source image.</param>
        /// <param>dst Destination image of the same size and the same number of channels</param>
        /// as <code>src</code>.
        /// <param>ddepth Desired depth of the destination image.</param>
        /// <param>ksize Aperture size used to compute the second-derivative filters. See</param>
        /// "getDerivKernels" for details. The size must be positive and odd.
        /// <param>scale Optional scale factor for the computed Laplacian values. By</param>
        /// default, no scaling is applied. See "getDerivKernels" for details.
        /// <param>delta Optional delta value that is added to the results prior to</param>
        /// storing them in <code>dst</code>.
        /// <param>borderType Pixel extrapolation method. See "borderInterpolate" for</param>
        /// details.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#laplacian">org.opencv.imgproc.Imgproc.Laplacian</a>
        ...
        public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize, double scale, double delta, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_Laplacian_10(src.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta, borderType);
        ...
        /// as <code>src</code>.</param>
        /// <param>ddepth Desired depth of the destination image.</param>
        /// <param>ksize Aperture size used to compute the second-derivative filters. See
        /// "getDerivKernels" for details. The size must be positive and odd.</param>
        /// <param>scale Optional scale factor for the computed Laplacian values. By
        /// default, no scaling is applied. See "getDerivKernels" for details.</param>
        ...
        public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize, double scale, double delta)
        {
            ...
            opencvunity_imgproc_Imgproc_Laplacian_11(src.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta);
        ...
        public static void Laplacian(Mat src, Mat dst, int ddepth)
        {
            ...
            opencvunity_imgproc_Imgproc_Laplacian_12(src.nativeObj, dst.nativeObj, ddepth);
        ...
        /// <summary>Calculates the first x- or y- image derivative using Scharr operator.</summary>
        ///
        ...
        /// combination of <code>src.depth()</code> and <code>ddepth</code>).</param>
        /// <param>dx order of the derivative x.</param>
        /// <param>dy order of the derivative y.</param>
        /// <param>scale optional scale factor for the computed derivative values; by
        /// default, no scaling is applied (see "getDerivKernels" for details).</param>
        /// <param>delta optional delta value that is added to the results prior to
        /// storing them in <code>dst</code>.</param>
        /// <param>borderType pixel extrapolation method (see "borderInterpolate" for
        /// details).
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#scharr">org.opencv.imgproc.Imgproc.Scharr</a>
        ...
        public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale, double delta, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_Scharr_10(src.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta, borderType);
        ...
        public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale, double delta)
        {
            ...
            opencvunity_imgproc_Imgproc_Scharr_11(src.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta);
        ...
        public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy)
        {
            ...
            opencvunity_imgproc_Imgproc_Scharr_12(src.nativeObj, dst.nativeObj, ddepth, dx, dy);
        ...
        /// <summary>Calculates the first, second, third, or mixed image derivatives using an
        ...
        ///
        /// <param>src input image.</param>
        /// <param>dst output image of the same size and the same number of channels as</param>
        /// <code>src</code>.
        /// <param>ddepth output image depth; the following combinations of</param>
        ...
        /// <param>dx a dx</param>
        /// <param>dy a dy</param>
        /// <param>ksize size of the extended Sobel kernel; it must be 1, 3, 5, or 7.</param>
        /// <param>scale optional scale factor for the computed derivative values; by</param>
        /// default, no scaling is applied (see "getDerivKernels" for details).
        /// <param>delta optional delta value that is added to the results prior to</param>
        /// storing them in <code>dst</code>.
        /// <param>borderType pixel extrapolation method (see "borderInterpolate" for</param>
        /// details).
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#sobel">org.opencv.imgproc.Imgproc.Sobel</a>
        /// org.opencv.imgproc.Imgproc#GaussianBlur
        /// org.opencv.core.Core#cartToPolar
        /// org.opencv.imgproc.Imgproc#sepFilter2D
        /// org.opencv.imgproc.Imgproc#Laplacian
        /// org.opencv.imgproc.Imgproc#Scharr
        /// org.opencv.imgproc.Imgproc#filter2D
        public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_Sobel_10(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta, borderType);

        }


        /// <summary>Calculates the first, second, third, or mixed image derivatives using an
        /// extended Sobel operator.</summary>
        ///
        /// <p>In all cases except one, the <em>ksize x&ltBR&gtksize</em> separable kernel
        /// is used to calculate the derivative. When <em>ksize = 1</em>, the <em>3 x
        /// 1</em> or <em>1 x 3</em> kernel is used (that is, no Gaussian smoothing is
        ...
        public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta)
        {
            ...
            opencvunity_imgproc_Imgproc_Sobel_11(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta);
        ...
        public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy)
        {
            ...
            opencvunity_imgproc_Imgproc_Sobel_12(src.nativeObj, dst.nativeObj, ddepth, dx, dy);
        ...
        /// <summary>Adds an image to the accumulator.</summary>
        ///
        ...
        ///
        /// <param>src Input image as 1- or 3-channel, 8-bit or 32-bit floating point.</param>
        /// <param>dst Accumulator image with the same number of channels as input image,
        /// 32-bit or 64-bit floating-point.</param>
        ...
        /// org.opencv.imgproc.Imgproc#accumulateWeighted
        ...
        public static void accumulate(Mat src, Mat dst, Mat mask)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulate_10(src.nativeObj, dst.nativeObj, mask.nativeObj);
        ...
        public static void accumulate(Mat src, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulate_11(src.nativeObj, dst.nativeObj);
        ...
        /// <summary>Adds the per-element product of two input images to the accumulator.</summary>
        ///
        ...
        public static void accumulateProduct(Mat src1, Mat src2, Mat dst, Mat mask)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateProduct_10(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
        ...
        public static void accumulateProduct(Mat src1, Mat src2, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateProduct_11(src1.nativeObj, src2.nativeObj, dst.nativeObj);
        ...
        /// <summary>Adds the square of a source image to the accumulator.</summary>
        ///
        ...
        ///
        /// <param>src Input image as 1- or 3-channel, 8-bit or 32-bit floating point.</param>
        /// <param>dst Accumulator image with the same number of channels as input image,</param>
        /// 32-bit or 64-bit floating-point.
        ...
        public static void accumulateSquare(Mat src, Mat dst, Mat mask)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateSquare_10(src.nativeObj, dst.nativeObj, mask.nativeObj);
        ...
        public static void accumulateSquare(Mat src, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateSquare_11(src.nativeObj, dst.nativeObj);
        ...
        /// <summary>Updates a running average.</summary>
        ///
        ...
        /// <param>dst Accumulator image with the same number of channels as input image,
        /// 32-bit or 64-bit floating-point.</param>
        /// <param>alpha Weight of the input image.</param>
        /// <param>mask Optional operation mask.
        ///
        ...
        public static void accumulateWeighted(Mat src, Mat dst, double alpha, Mat mask)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateWeighted_10(src.nativeObj, dst.nativeObj, alpha, mask.nativeObj);
        ...
        public static void accumulateWeighted(Mat src, Mat dst, double alpha)
        {
            ...
            opencvunity_imgproc_Imgproc_accumulateWeighted_11(src.nativeObj, dst.nativeObj, alpha);
        ...
        /// <summary>Applies an adaptive threshold to an array.</summary>
        ///
        ...
        ///
        /// <param>src Source 8-bit single-channel image.</param>
        /// <param>dst Destination image of the same size and the same type as</param>
        /// <code>src</code>.
        /// <param>maxValue Non-zero value assigned to the pixels for which the condition</param>
        /// is satisfied. See the details below.
        /// <param>adaptiveMethod Adaptive thresholding algorithm to use,</param>
        /// <code>ADAPTIVE_THRESH_MEAN_C</code> or <code>ADAPTIVE_THRESH_GAUSSIAN_C</code>.
        /// See the details below.
        /// <param>thresholdType Thresholding type that must be either <code>THRESH_BINARY</code></param>
        /// or <code>THRESH_BINARY_INV</code>.
        /// <param>blockSize Size of a pixel neighborhood that is used to calculate a</param>
        /// threshold value for the pixel: 3, 5, 7, and so on.
        /// <param>C Constant subtracted from the mean or weighted mean (see the details</param>
        ...
        public static void adaptiveThreshold(Mat src, Mat dst, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C)
        {
            ...
            opencvunity_imgproc_Imgproc_adaptiveThreshold_10(src.nativeObj, dst.nativeObj, maxValue, adaptiveMethod, thresholdType, blockSize, C);
        ...
        /// <summary>Approximates a polygonal curve(s) with the specified precision.</summary>
        ///
        ...
        /// stored in the memory storage and pointer to it is returned.</param>
        /// <param>epsilon Parameter specifying the approximation accuracy. This is the
        /// maximum distance between the original curve and its approximation.</param>
        ...
        public static void approxPolyDP(MatOfPoint2f curve, MatOfPoint2f approxCurve, double epsilon, bool closed)
        {
            ...
            opencvunity_imgproc_Imgproc_approxPolyDP_10(curve_mat.nativeObj, approxCurve_mat.nativeObj, epsilon, closed);
        ...
        /// <summary>Calculates a contour perimeter or a curve length.</summary>
        ///
        ...
        public static double arcLength(MatOfPoint2f curve, bool closed)
        {
            ...
            Mat curve_mat = curve;
            double retVal = opencvunity_imgproc_Imgproc_arcLength_10(curve_mat.nativeObj, closed);
        ...
        /// <summary>Applies the bilateral filter to an image.</summary>
        ///
        ...
        ///
        /// <param>src Source 8-bit or floating-point, 1-channel or 3-channel image.</param>
        /// <param>dst Destination image of the same size and type as <code>src</code>.</param>
        /// <param>d Diameter of each pixel neighborhood that is used during filtering.
        /// If it is non-positive, it is computed from <code>sigmaSpace</code>.</param>
        ...
        /// <code>sigmaSpace</code>) will be mixed together, resulting in larger areas of</param>
        ...
        /// <code>sigmaSpace</code>. Otherwise, <code>d</code> is proportional to</param>
        /// <param>borderType a borderType
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#bilateralfilter">org.opencv.imgproc.Imgproc.bilateralFilter</a>
        public static void bilateralFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_bilateralFilter_10(src.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, borderType);
        ...
        public static void bilateralFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace)
        {
            ...
            opencvunity_imgproc_Imgproc_bilateralFilter_11(src.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace);
        }
        ...
        /// <summary>Blurs an image using the normalized box filter.</summary>
        ///
        ...
        /// <code>CV_64F</code>.</param>
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>ksize blurring kernel size.</param>
        /// <param>anchor anchor point; default value <code>Point(-1,-1)</code> means
        /// that the anchor is at the kernel center.</param>
        /// <param>borderType border mode used to extrapolate pixels outside of the
        /// image.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#blur">org.opencv.imgproc.Imgproc.blur</a>
        /// org.opencv.imgproc.Imgproc#boxFilter
        /// org.opencv.imgproc.Imgproc#GaussianBlur
        /// org.opencv.imgproc.Imgproc#bilateralFilter
        /// org.opencv.imgproc.Imgproc#medianBlur
        public static void blur(Mat src, Mat dst, Size ksize, Point anchor, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_blur_10(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.x, anchor.y, borderType);
        }
        ...
        public static void blur(Mat src, Mat dst, Size ksize, Point anchor)
        {
            ...
            opencvunity_imgproc_Imgproc_blur_11(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.x, anchor.y);
        ...
        public static void blur(Mat src, Mat dst, Size ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_blur_12(src.nativeObj, dst.nativeObj, ksize.width, ksize.height);
        }
        ...
        /// <summary>Calculates the up-right bounding rectangle of a point set.</summary>
        ///
        ...
        public static Rect boundingRect(MatOfPoint points)
        {
            ...
            opencvunity_imgproc_Imgproc_boundingRect_10(points_mat.nativeObj, tmpArray);
        ...
        /// <summary>Blurs an image using the box filter.</summary>
        ///
        /// <p>The function smoothes an image using the kernel:</p>
        ///
        ...
        /// <param>src input image.</param>
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>ddepth the output image depth (-1 to use <code>src.depth()</code>).</param>
        /// <param>ksize blurring kernel size.</param>
        /// <param>anchor anchor point; default value <code>Point(-1,-1)</code> means
        /// that the anchor is at the kernel center.</param>
        ...
        /// image.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#boxfilter">org.opencv.imgproc.Imgproc.boxFilter</a>
        /// org.opencv.imgproc.Imgproc#GaussianBlur
        /// org.opencv.imgproc.Imgproc#medianBlur
        ...
        public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, bool normalize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_boxFilter_10(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y, normalize, borderType);
        ...
        public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, bool normalize)
        {
            ...
            opencvunity_imgproc_Imgproc_boxFilter_11(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y, normalize);
        ...
        public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_boxFilter_12(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height);
        ...
        /// <summary>Calculates the back projection of a histogram.</summary>
        ///
        ...
        /// can have an arbitrary number of channels.</param>
        ...
        /// <code>images[0].channels() + images[1].channels()-1</code>, and so on.</param>
        /// <param>hist Input histogram that can be dense or sparse.</param>
        /// <param>dst a dst</param>
        /// <param>ranges Array of arrays of the histogram bin boundaries in each
        /// dimension. See "calcHist".</param>
        ...
        public static void calcBackProject(List<Mat> images, MatOfInt channels, Mat hist, Mat dst, MatOfFloat ranges, double scale)
        {
            ...
            opencvunity_imgproc_Imgproc_calcBackProject_10(images_mat.nativeObj, channels_mat.nativeObj, hist.nativeObj, dst.nativeObj, ranges_mat.nativeObj, scale);
        ...
        /// <summary>Calculates a histogram of a set of arrays.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>images Source arrays. They all should have the same depth,</param>
        /// <code>CV_8U</code> or <code>CV_32F</code>, and the same size. Each of them
        /// can have an arbitrary number of channels.
        /// <param>channels List of the <code>dims</code> channels used to compute the</param>
        ...
        /// <param>mask Optional mask. If the matrix is not empty, it must be an 8-bit</param>
        /// array of the same size as <code>images[i]</code>. The non-zero mask elements
        /// mark the array elements counted in the histogram.
        /// <param>hist Output histogram, which is a dense or sparse <code>dims</code></param>
        /// -dimensional array.
        /// <param>histSize Array of histogram sizes in each dimension.</param>
        /// <param>ranges Array of the <code>dims</code> arrays of the histogram bin</param>
        ...
        /// <param>accumulate Accumulation flag. If it is set, the histogram is not</param>
        ...
        /// histogram in time.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/histograms.html#calchist">org.opencv.imgproc.Imgproc.calcHist</a>
        public static void calcHist(List<Mat> images, MatOfInt channels, Mat mask, Mat hist, MatOfInt histSize, MatOfFloat ranges, bool accumulate)
        {
            ...
            Mat ranges_mat = ranges;
            opencvunity_imgproc_Imgproc_calcHist_10(images_mat.nativeObj, channels_mat.nativeObj, mask.nativeObj, hist.nativeObj, histSize_mat.nativeObj, ranges_mat.nativeObj, accumulate);
        ...
        /// histogram. The first array channels are numerated from 0 to <code>images[0].channels()-1</code>,
        /// the second array channels are counted from <code>images[0].channels()</code>
        /// to <code>images[0].channels() + images[1].channels()-1</code>, and so on.</param>
        /// <param>mask Optional mask. If the matrix is not empty, it must be an 8-bit
        /// array of the same size as <code>images[i]</code>. The non-zero mask elements
        /// mark the array elements counted in the histogram.</param>
        /// <param>hist Output histogram, which is a dense or sparse <code>dims</code>
        /// -dimensional array.</param>
        /// <param>histSize Array of histogram sizes in each dimension.</param>
        ...
        public static void calcHist(List<Mat> images, MatOfInt channels, Mat mask, Mat hist, MatOfInt histSize, MatOfFloat ranges)
        {
            ...
            Mat histSize_mat = histSize;
            Mat ranges_mat = ranges;
            opencvunity_imgproc_Imgproc_calcHist_11(images_mat.nativeObj, channels_mat.nativeObj, mask.nativeObj, hist.nativeObj, histSize_mat.nativeObj, ranges_mat.nativeObj);
        ...
        /// <summary>Compares two histograms.</summary>
        ///
        ...
        /// "EMD" function.</p>
        ///
        /// <param>H1 First compared histogram.</param>
        /// <param>H2 Second compared histogram of the same size as <code>H1</code>.</param>
        ...
        /// </ul>
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/histograms.html#comparehist">org.opencv.imgproc.Imgproc.compareHist</a>
        public static double compareHist(Mat H1, Mat H2, int method)
        {
            ...
            double retVal = opencvunity_imgproc_Imgproc_compareHist_10(H1.nativeObj, H2.nativeObj, method);
        ...
        /// <summary>Calculates a contour area.</summary>
        ///
        ...
        ///
        /// <param>contour Input vector of 2D points (contour vertices), stored in</param>
        /// <code>std.vector</code> or <code>Mat</code>.
        /// <param>oriented Oriented area flag. If it is true, the function returns a</param>
        ...
        public static double contourArea(Mat contour, bool oriented)
        {
            ...
            double retVal = opencvunity_imgproc_Imgproc_contourArea_10(contour.nativeObj, oriented);
        ...
        public static double contourArea(Mat contour)
        {
            ...
            double retVal = opencvunity_imgproc_Imgproc_contourArea_11(contour.nativeObj);
        ...
        /// <summary>Converts image transformation maps from one representation to another.</summary>
        ///
        ...
        /// <code>CV_32FC1</code>, or <code>CV_32FC2</code>.</param>
        /// <param>map2 The second input map of type <code>CV_16UC1</code>,
        /// <code>CV_32FC1</code>, or none (empty matrix), respectively.</param>
        /// <param>dstmap1 The first output map that has the type <code>dstmap1type</code>
        /// and the same size as <code>src</code>.</param>
        /// <param>dstmap2 The second output map.</param>
        /// <param>dstmap1type Type of the first output map that should be
        /// <code>CV_16SC2</code>, <code>CV_32FC1</code>, or <code>CV_32FC2</code>.</param>
        ...
        public static void convertMaps(Mat map1, Mat map2, Mat dstmap1, Mat dstmap2, int dstmap1type, bool nninterpolation)
        {
            ...
            opencvunity_imgproc_Imgproc_convertMaps_10(map1.nativeObj, map2.nativeObj, dstmap1.nativeObj, dstmap2.nativeObj, dstmap1type, nninterpolation);
        ...
        /// </ul>
        ///
        /// <param>map1 The first input map of type <code>CV_16SC2</code>,</param>
        /// <code>CV_32FC1</code>, or <code>CV_32FC2</code>.
        /// <param>map2 The second input map of type <code>CV_16UC1</code>,</param>
        /// <code>CV_32FC1</code>, or none (empty matrix), respectively.
        /// <param>dstmap1 The first output map that has the type <code>dstmap1type</code></param>
        /// and the same size as <code>src</code>.
        /// <param>dstmap2 The second output map.</param>
        /// <param>dstmap1type Type of the first output map that should be</param>
        ...
        public static void convertMaps(Mat map1, Mat map2, Mat dstmap1, Mat dstmap2, int dstmap1type)
        {
            ...
            opencvunity_imgproc_Imgproc_convertMaps_11(map1.nativeObj, map2.nativeObj, dstmap1.nativeObj, dstmap2.nativeObj, dstmap1type);
        ...
        /// <summary>Finds the convex hull of a point set.</summary>
        ///
        ...
        public static void convexHull(MatOfPoint points, MatOfInt hull, bool clockwise)
        {
            ...
            Mat points_mat = points;
            Mat hull_mat = hull;
            opencvunity_imgproc_Imgproc_convexHull_10(points_mat.nativeObj, hull_mat.nativeObj, clockwise);
        }
        ...
        public static void convexHull(MatOfPoint points, MatOfInt hull)
        {
            ...
            Mat points_mat = points;
            Mat hull_mat = hull;
            opencvunity_imgproc_Imgproc_convexHull_11(points_mat.nativeObj, hull_mat.nativeObj);
        }
        ...
        /// <summary>Finds the convexity defects of a contour.</summary>
        ///
        ...
        ///
        /// <param>contour Input contour.</param>
        /// <param>convexhull Convex hull obtained using "convexHull" that should contain
        /// indices of the contour points that make the hull.</param>
        ...
        public static void convexityDefects(MatOfPoint contour, MatOfInt convexhull, MatOfInt4 convexityDefects)
        {
            ...
            opencvunity_imgproc_Imgproc_convexityDefects_10(contour_mat.nativeObj, convexhull_mat.nativeObj, convexityDefects_mat.nativeObj);
        ...
        /// <summary>Calculates eigenvalues and eigenvectors of image blocks for corner detection.</summary>
        ///
        ...
        /// <param>dst Image to store the results. It has the same size as</param>
        /// <code>src</code> and the type <code>CV_32FC(6)</code>.
        /// <param>blockSize Neighborhood size (see details below).</param>
        /// <param>ksize Aperture parameter for the "Sobel" operator.</param>
        /// <param>borderType Pixel extrapolation method. See "borderInterpolate".</param>
        ///
        ...
        public static void cornerEigenValsAndVecs(Mat src, Mat dst, int blockSize, int ksize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerEigenValsAndVecs_10(src.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
        ...
        /// <code>src</code> and the type <code>CV_32FC(6)</code>.</param>
        /// <param>blockSize Neighborhood size (see details below).</param>
        ...
        public static void cornerEigenValsAndVecs(Mat src, Mat dst, int blockSize, int ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerEigenValsAndVecs_11(src.nativeObj, dst.nativeObj, blockSize, ksize);
        ...
        /// <code>CV_32FC1</code> and the same size as <code>src</code>.</param>
        ...
        public static void cornerHarris(Mat src, Mat dst, int blockSize, int ksize, double k, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerHarris_10(src.nativeObj, dst.nativeObj, blockSize, ksize, k, borderType);
        ...
        public static void cornerHarris(Mat src, Mat dst, int blockSize, int ksize, double k)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerHarris_11(src.nativeObj, dst.nativeObj, blockSize, ksize, k);
        ...
        /// <summary>Calculates the minimal eigenvalue of gradient matrices for corner detection.</summary>
        ///
        ...
        public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize, int ksize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerMinEigenVal_10(src.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
        ...
        public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize, int ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerMinEigenVal_11(src.nativeObj, dst.nativeObj, blockSize, ksize);
        ...
        public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerMinEigenVal_12(src.nativeObj, dst.nativeObj, blockSize);
        ...
        public static void cornerSubPix(Mat image, MatOfPoint2f corners, Size winSize, Size zeroZone, TermCriteria criteria)
        {
            ...
            opencvunity_imgproc_Imgproc_cornerSubPix_10(image.nativeObj, corners_mat.nativeObj, winSize.width, winSize.height, zeroZone.width, zeroZone.height, criteria.type, criteria.maxCount, criteria.epsilon);
        ...
        /// <summary>This function computes a Hanning window coefficients in two dimensions. See
        ...
        ///
        /// <param>dst Destination array to place Hann coefficients in</param>
        /// <param>winSize The window size specifications</param>
        ...
        /// org.opencv.imgproc.Imgproc#phaseCorrelate
        public static void createHanningWindow(Mat dst, Size winSize, int type)
        {
            if (dst != null)
                dst.ThrowIfDisposed();

            opencvunity_imgproc_Imgproc_createHanningWindow_10(dst.nativeObj, winSize.width, winSize.height, type);
        ...
        /// <summary>Converts an image from one color space to another.</summary>
        ///
        ...
        /// <p>popular "BG" type.</p>
        ///
        /// <param>src input image: 8-bit unsigned, 16-bit unsigned (<code>CV_16UC...</code>),</param>
        /// or single-precision floating-point.
        /// <param>dst output image of the same size and depth as <code>src</code>.</param>
        /// <param>code color space conversion code (see the description below).</param>
        /// <param>dstCn number of channels in the destination image; if the parameter is</param>
        ...
        public static void cvtColor(Mat src, Mat dst, int code, int dstCn)
        {
            ...
            opencvunity_imgproc_Imgproc_cvtColor_10(src.nativeObj, dst.nativeObj, code, dstCn);
        ...
        /// or single-precision floating-point.</param>
        /// <param>dst output image of the same size and depth as <code>src</code>.</param>
        ...
        public static void cvtColor(Mat src, Mat dst, int code)
        {
            ...
            opencvunity_imgproc_Imgproc_cvtColor_11(src.nativeObj, dst.nativeObj, code);
        ...
        /// <summary>Dilates an image by using a specific structuring element.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>src input image; the number of channels can be arbitrary, but the</param>
        /// depth should be one of <code>CV_8U</code>, <code>CV_16U</code>,
        /// <code>CV_16S</code>, <code>CV_32F" or </code>CV_64F".
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>kernel a kernel</param>
        /// <param>anchor position of the anchor within the element; default value</param>
        /// <code>(-1, -1)</code> means that the anchor is at the element center.
        /// <param>iterations number of times dilation is applied.</param>
        /// <param>borderType pixel extrapolation method (see "borderInterpolate" for</param>
        /// details).
        /// <param>borderValue border value in case of a constant border (see</param>
        /// "createMorphologyFilter" for details).
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#dilate">org.opencv.imgproc.Imgproc.dilate</a>
        ...
        public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_dilate_10(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        /// depth should be one of <code>CV_8U</code>, <code>CV_16U</code>,
        /// <code>CV_16S</code>, <code>CV_32F" or </code>CV_64F".</param>
        /// <param>dst output image of the same size and type as <code>src</code>.</param>
        /// <param>kernel a kernel</param>
        /// <param>anchor position of the anchor within the element; default value
        /// <code>(-1, -1)</code> means that the anchor is at the element center.</param>
        ...
        public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations)
        {
            ...
            opencvunity_imgproc_Imgproc_dilate_11(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations);
        ...
        public static void dilate(Mat src, Mat dst, Mat kernel)
        {
            ...
            opencvunity_imgproc_Imgproc_dilate_12(src.nativeObj, dst.nativeObj, kernel.nativeObj);
        ...
        /// <summary>Calculates the distance to the closest zero pixel for each pixel of the
        /// source image.</p>
        ///
        ...
        /// </ul>
        ///
        /// <param>src 8-bit, single-channel (binary) source image.</param>
        /// <param>dst Output image with calculated distances. It is a 32-bit</param>
        /// floating-point, single-channel image of the same size as <code>src</code>.
        /// <param>distanceType Type of distance. It can be <code>CV_DIST_L1,</param>
        /// CV_DIST_L2</code>, or <code>CV_DIST_C</code>.
        /// <param>maskSize Size of the distance transform mask. It can be 3, 5, or</param>
        ...
        public static void distanceTransform(Mat src, Mat dst, int distanceType, int maskSize)
        {
            ...
            opencvunity_imgproc_Imgproc_distanceTransform_10(src.nativeObj, dst.nativeObj, distanceType, maskSize);
        ...
        /// floating-point, single-channel image of the same size as <code>src</code>.</param>
        ...
        /// <code>src</code>. See the details below.</param>
        /// <param>distanceType Type of distance. It can be <code>CV_DIST_L1,
        /// CV_DIST_L2</code>, or <code>CV_DIST_C</code>.</param>
        /// <param>maskSize Size of the distance transform mask. It can be 3, 5, or
        /// <code>CV_DIST_MASK_PRECISE</code> (the latter option is only supported by the
        /// first function). In case of the <code>CV_DIST_L1</code> or <code>CV_DIST_C</code>
        /// distance type, the parameter is forced to 3 because a <em>3x 3</em> mask
        /// gives the same result as <em>5x 5</em> or any larger aperture.</param>
        ...
        public static void distanceTransformWithLabels(Mat src, Mat dst, Mat labels, int distanceType, int maskSize, int labelType)
        {
            ...
            opencvunity_imgproc_Imgproc_distanceTransformWithLabels_10(src.nativeObj, dst.nativeObj, labels.nativeObj, distanceType, maskSize, labelType);
        ...
        /// <param>dst Output image with calculated distances. It is a 32-bit</param>
        /// floating-point, single-channel image of the same size as <code>src</code>.
        /// <param>labels Optional output 2D array of labels (the discrete Voronoi</param>
        /// diagram). It has the type <code>CV_32SC1</code> and the same size as
        ...
        public static void distanceTransformWithLabels(Mat src, Mat dst, Mat labels, int distanceType, int maskSize)
        {
            ...
            opencvunity_imgproc_Imgproc_distanceTransformWithLabels_11(src.nativeObj, dst.nativeObj, labels.nativeObj, distanceType, maskSize);
        ...
        /// <summary>Draws contours outlines or filled contours.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image Destination image.</param>
        ...
        /// all the contours are drawn.</param>
        /// <param>color Color of the contours.</param>
        ...
        /// interiors are drawn.</param>
        /// <param>lineType Line connectivity. See "line" for details.</param>
        /// <param>hierarchy Optional information about hierarchy. It is only needed if
        /// you want to draw only some of the contours (see <code>maxLevel</code>).</param>
        ...
        /// is only taken into account when there is <code>hierarchy</code> available.</param>
        ...
        public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy, int maxLevel, Point offset)
        {
            ...
            opencvunity_imgproc_Imgproc_drawContours_10(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel, offset.x, offset.y);
        }
        ...
        ///
        /// <param>image Destination image.</param>
        /// <param>contours All the input contours. Each contour is stored as a point</param>
        /// vector.
        /// <param>contourIdx Parameter indicating a contour to draw. If it is negative,</param>
        /// all the contours are drawn.
        /// <param>color Color of the contours.</param>
        /// <param>thickness Thickness of lines the contours are drawn with. If it is</param>
        /// negative (for example, <code>thickness=CV_FILLED</code>), the contour
        /// interiors are drawn.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
        public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color, int thickness)
        {
            ...
            List<Mat> contours_tmplm = new List<Mat>((contours != null) ? contours.Count : 0);
            Mat contours_mat = Converters.vector_vector_Point_to_Mat(contours, contours_tmplm);
            opencvunity_imgproc_Imgproc_drawContours_11(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color)
        {
            ...
            List<Mat> contours_tmplm = new List<Mat>((contours != null) ? contours.Count : 0);
            Mat contours_mat = Converters.vector_vector_Point_to_Mat(contours, contours_tmplm);
            opencvunity_imgproc_Imgproc_drawContours_12(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        /// <summary>Equalizes the histogram of a grayscale image.</summary>
        ///
        ...
        /// <param>dst Destination image of the same size and type as <code>src</code>.</param>
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/histograms.html#equalizehist">org.opencv.imgproc.Imgproc.equalizeHist</a>
        public static void equalizeHist(Mat src, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_equalizeHist_10(src.nativeObj, dst.nativeObj);
        ...
        /// <summary>Erodes an image by using a specific structuring element.</summary>
        ///
        ...
        /// <param>anchor position of the anchor within the element; default value</param>
        /// <code>(-1, -1)</code> means that the anchor is at the element center.
        /// <param>iterations number of times erosion is applied.</param>
        /// <param>borderType pixel extrapolation method (see "borderInterpolate" for</param>
        /// details).
        /// <param>borderValue border value in case of a constant border (see</param>
        /// "createMorphologyFilter" for details).
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#erode">org.opencv.imgproc.Imgproc.erode</a>
        /// org.opencv.imgproc.Imgproc#morphologyEx
        ...
        public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_erode_10(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations)
        {
            ...
            opencvunity_imgproc_Imgproc_erode_11(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations);
        ...
        public static void erode(Mat src, Mat dst, Mat kernel)
        {
            ...
            opencvunity_imgproc_Imgproc_erode_12(src.nativeObj, dst.nativeObj, kernel.nativeObj);
        ...
        /// <summary>Convolves an image with the kernel.</summary>
        ///
        ...
        /// <param>dst output image of the same size and the same number of channels as</param>
        /// <code>src</code>.
        /// <param>ddepth desired depth of the destination image; if it is negative, it</param>
        ...
        /// source.</p>
        /// <param>kernel convolution kernel (or rather a correlation kernel), a</param>
        ...
        /// <param>anchor anchor of the kernel that indicates the relative position of a</param>
        ...
        /// <param>delta optional value added to the filtered pixels before storing them</param>
        /// in <code>dst</code>.
        /// <param>borderType pixel extrapolation method (see "borderInterpolate" for</param>
        /// details).
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#filter2d">org.opencv.imgproc.Imgproc.filter2D</a>
        ...
        public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_filter2D_10(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.x, anchor.y, delta, borderType);
        ...
        public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta)
        {
            ...
            opencvunity_imgproc_Imgproc_filter2D_11(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.x, anchor.y, delta);
        ...
        public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel)
        {
            ...
            opencvunity_imgproc_Imgproc_filter2D_12(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj);
        ...
        /// <summary>Finds contours in a binary image.</summary>
        ///
        ...
        /// of labels (<code>CV_32SC1</code>).</param>
        ...
        /// corresponding elements of <code>hierarchy[i]</code> will be negative.</param>
        ...
        public static void findContours(Mat image, List<MatOfPoint> contours, Mat hierarchy, int mode, int method, Point offset)
        {
            ...
            opencvunity_imgproc_Imgproc_findContours_10(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method, offset.x, offset.y);
        ...
        public static void findContours(Mat image, List<MatOfPoint> contours, Mat hierarchy, int mode, int method)
        {
            ...
            Mat contours_mat = new Mat();
            opencvunity_imgproc_Imgproc_findContours_11(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method);
            Converters.Mat_to_vector_vector_Point(contours_mat, contours);
        }
        ...
        public static RotatedRect fitEllipse(MatOfPoint2f points)
        {
            ...
            opencvunity_imgproc_Imgproc_fitEllipse_10(points_mat.nativeObj, tmpArray);
        ...
        /// <summary>Fits a line to a 2D or 3D point set.</summary>
        ///
        ...
        /// point on the line.</param>
        /// <param>distType Distance used by the M-estimator (see the discussion below).</param>
        /// <param>param Numerical parameter (<code>C</code>) for some types of
        /// distances. If it is 0, an optimal value is chosen.</param>
        /// <param>reps Sufficient accuracy for the radius (distance between the
        /// coordinate origin and the line).</param>
        ...
        public static void fitLine(Mat points, Mat line, int distType, double param, double reps, double aeps)
        {
            ...
            opencvunity_imgproc_Imgproc_fitLine_10(points.nativeObj, line.nativeObj, distType, param, reps, aeps);
        ...
        /// <summary>Fills a connected component with the given color.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image Input/output 1- or 3-channel, 8-bit, or floating-point image. It</param>
        ...
        /// <param>mask Operation mask that should be a single-channel 8-bit image, 2</param>
        ...
        /// <code>mask</code>.</p>
        /// <param>seedPoint Starting point.</param>
        /// <param>newVal New value of the repainted domain pixels.</param>
        /// <param>rect Optional output parameter set by the function to the minimum</param>
        /// bounding rectangle of the repainted domain.
        /// <param>loDiff Maximal lower brightness/color difference between the currently</param>
        /// observed pixel and one of its neighbors belonging to the component, or a seed
        /// pixel being added to the component.
        /// <param>upDiff Maximal upper brightness/color difference between the currently</param>
        /// observed pixel and one of its neighbors belonging to the component, or a seed
        /// pixel being added to the component.
        /// <param>flags Operation flags. The first 8 bits contain a connectivity value.</param>
        ...
        public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff, Scalar upDiff, int flags)
        {
            ...
            int retVal = opencvunity_imgproc_Imgproc_floodFill_10(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out, loDiff.val[0], loDiff.val[1], loDiff.val[2], loDiff.val[3], upDiff.val[0], upDiff.val[1], upDiff.val[2], upDiff.val[3], flags);
            if (rect != null)
            {
        ...
        /// is modified by the function unless the <code>FLOODFILL_MASK_ONLY</code> flag
        /// is set in the second variant of the function. See the details below.</param>
        ...
        public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal)
        {
            ...
            int retVal = opencvunity_imgproc_Imgproc_floodFill_11(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3]);
        ...
        /// <summary>Calculates an affine transform from three pairs of the corresponding points.</summary>
        ///
        ...
        ///
        /// <param>src Coordinates of triangle vertices in the source image.</param>
        ...
        public static Mat getAffineTransform(MatOfPoint2f src, MatOfPoint2f dst)
        {
            ...
            Mat src_mat = src;
            Mat dst_mat = dst;
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getAffineTransform_10(src_mat.nativeObj, dst_mat.nativeObj));
        ...
        /// <summary>Returns the default new camera matrix.</summary>
        ///
        ...
        /// <param>imgsize Camera view image size in pixels.</param>
        ...
        public static Mat getDefaultNewCameraMatrix(Mat cameraMatrix, Size imgsize, bool centerPrincipalPoint)
        {
            ...
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getDefaultNewCameraMatrix_10(cameraMatrix.nativeObj, imgsize.width, imgsize.height, centerPrincipalPoint));
        ...
        public static Mat getDefaultNewCameraMatrix(Mat cameraMatrix)
        {
            ...
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getDefaultNewCameraMatrix_11(cameraMatrix.nativeObj));
        ...
        public static void getDerivKernels(Mat kx, Mat ky, int dx, int dy, int ksize, bool normalize, int ktype)
        {
            ...
            opencvunity_imgproc_Imgproc_getDerivKernels_10(kx.nativeObj, ky.nativeObj, dx, dy, ksize, normalize, ktype);
        ...
        public static void getDerivKernels(Mat kx, Mat ky, int dx, int dy, int ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_getDerivKernels_11(kx.nativeObj, ky.nativeObj, dx, dy, ksize);
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getGaborKernel_10(ksize.width, ksize.height, sigma, theta, lambd, gamma, psi, ktype));
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getGaborKernel_11(ksize.width, ksize.height, sigma, theta, lambd, gamma));
        ...
        /// <summary>Returns Gaussian filter coefficients.</summary>
        ///
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getGaussianKernel_10(ksize, sigma, ktype));
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getGaussianKernel_11(ksize, sigma));
        ...
        /// <summary>Calculates a perspective transform from four pairs of the corresponding
        /// points.</p>
        ///
        ...
        ///
        /// <param>src Coordinates of quadrangle vertices in the source image.</param>
        /// <param>dst Coordinates of the corresponding quadrangle vertices in the</param>
        /// destination image.
        ///
        ...
        public static Mat getPerspectiveTransform(Mat src, Mat dst)
        {
            ...
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getPerspectiveTransform_10(src.nativeObj, dst.nativeObj));
        ...
        /// <summary>Retrieves a pixel rectangle from an image with sub-pixel accuracy.</summary>
        ///
        ...
        /// <param>patchSize Size of the extracted patch.</param>
        /// <param>center Floating point coordinates of the center of the extracted
        /// rectangle within the source image. The center must be inside the image.</param>
        /// <param>patch a patch</param>
        ...
        public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch, int patchType)
        {
            ...
            opencvunity_imgproc_Imgproc_getRectSubPix_10(image.nativeObj, patchSize.width, patchSize.height, center.x, center.y, patch.nativeObj, patchType);
        ...
        public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch)
        {
            ...
            opencvunity_imgproc_Imgproc_getRectSubPix_11(image.nativeObj, patchSize.width, patchSize.height, center.x, center.y, patch.nativeObj);
        ...
        /// <summary>Calculates an affine matrix of 2D rotation.</summary>
        ///
        ...
        ///
        /// <param>center Center of the rotation in the source image.</param>
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getRotationMatrix2D_10(center.x, center.y, angle, scale));
        ...
        /// <summary>Returns a structuring element of the specified size and shape for
        ...
        ///
        /// <param>shape Element shape that could be one of the following:</param>
        /// <ul>
        ...
        /// </ul>
        /// <param>ksize Size of the structuring element.</param>
        /// <param>anchor Anchor position within the element. The default value <em>(-1,</param>
        ...
        public static Mat getStructuringElement(int shape, Size ksize, Point anchor)
        {
            ...
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getStructuringElement_10(shape, ksize.width, ksize.height, anchor.x, anchor.y));
        ...
        {
            Mat retVal = new Mat(opencvunity_imgproc_Imgproc_getStructuringElement_11(shape, ksize.width, ksize.height));
        ...
        /// <summary>Determines strong corners on an image.</summary>
        ///
        ...
        ///
        /// <param>image Input 8-bit or floating-point 32-bit, single-channel image.</param>
        /// <param>corners Output vector of detected corners.</param>
        /// <param>maxCorners Maximum number of corners to return. If there are more
        /// corners than are found, the strongest of them is returned.</param>
        ...
        /// all the corners with the quality measure less than 15 are rejected.</param>
        ...
        /// it specifies the region in which the corners are detected.</param>
        /// <param>blockSize Size of an average block for computing a derivative
        /// covariation matrix over each pixel neighborhood. See "cornerEigenValsAndVecs".</param>
        /// <param>useHarrisDetector Parameter indicating whether to use a Harris
        /// detector (see "cornerHarris") or "cornerMinEigenVal".</param>
        ...
        public static void goodFeaturesToTrack(Mat image, MatOfPoint corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, int blockSize, bool useHarrisDetector, double k)
        {
            ...
            Mat corners_mat = corners;
            opencvunity_imgproc_Imgproc_goodFeaturesToTrack_10(image.nativeObj, corners_mat.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj, blockSize, useHarrisDetector, k);
        ...
        /// <param>image Input 8-bit or floating-point 32-bit, single-channel image.</param>
        /// <param>corners Output vector of detected corners.</param>
        /// <param>maxCorners Maximum number of corners to return. If there are more</param>
        /// corners than are found, the strongest of them is returned.
        /// <param>qualityLevel Parameter characterizing the minimal accepted quality of</param>
        /// image corners. The parameter value is multiplied by the best corner quality
        /// measure, which is the minimal eigenvalue (see "cornerMinEigenVal") or the
        /// Harris function response (see "cornerHarris"). The corners with the quality
        /// measure less than the product are rejected. For example, if the best corner
        ...
        /// <param>minDistance Minimum possible Euclidean distance between the returned</param>
        /// corners.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/feature_detection.html#goodfeaturestotrack">org.opencv.imgproc.Imgproc.goodFeaturesToTrack</a>
        /// org.opencv.imgproc.Imgproc#cornerHarris
        ...
        public static void goodFeaturesToTrack(Mat image, MatOfPoint corners, int maxCorners, double qualityLevel, double minDistance)
        {
            ...
            Mat corners_mat = corners;
            opencvunity_imgproc_Imgproc_goodFeaturesToTrack_11(image.nativeObj, corners_mat.nativeObj, maxCorners, qualityLevel, minDistance);
        ...
        /// <summary>Runs the GrabCut algorithm.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>img Input 8-bit 3-channel image.</param>
        ...
        /// <code>mode==GC_INIT_WITH_RECT</code>.</param>
        /// <param>bgdModel Temporary array for the background model. Do not modify it
        /// while you are processing the same image.</param>
        ...
        /// with <code>mode==GC_INIT_WITH_MASK</code> or <code>mode==GC_EVAL</code>.</param>
        ...
        public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount, int mode)
        {
            ...
            opencvunity_imgproc_Imgproc_grabCut_10(img.nativeObj, mask.nativeObj, rect.x, rect.y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount, mode);
        ...
        ///
        /// <param>img Input 8-bit 3-channel image.</param>
        /// <param>mask Input/output 8-bit single-channel mask. The mask is initialized</param>
        /// by the function when <code>mode</code> is set to <code>GC_INIT_WITH_RECT</code>.
        /// Its elements may have one of following values:
        /// <ul>
        ///   <li> GC_BGD defines an obvious background pixels.
        ...
        ///   <li> GC_PR_FGD defines a possible foreground pixel.
        /// </ul>
        /// <param>rect ROI containing a segmented object. The pixels outside of the ROI</param>
        /// are marked as "obvious background". The parameter is only used when
        /// <code>mode==GC_INIT_WITH_RECT</code>.
        /// <param>bgdModel Temporary array for the background model. Do not modify it</param>
        /// while you are processing the same image.
        /// <param>fgdModel Temporary arrays for the foreground model. Do not modify it</param>
        /// while you are processing the same image.
        /// <param>iterCount Number of iterations the algorithm should make before</param>
        /// returning the result. Note that the result can be refined with further calls
        ...
        public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount)
        {
            ...
            opencvunity_imgproc_Imgproc_grabCut_11(img.nativeObj, mask.nativeObj, rect.x, rect.y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount);
        ...
        /// <summary>Computes the undistortion and rectification transformation map.</summary>
        ///
        ...
        /// |0 0 1|
        /// </em>.</p></param>
        /// <param>size Undistorted image size.</param>
        /// <param>m1type Type of the first output map that can be <code>CV_32FC1</code>
        /// or <code>CV_16SC2</code>. See "convertMaps" for details.</param>
        /// <param>map1 The first output map.</param>
        ...
        public static void initUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix, Size size, int m1type, Mat map1, Mat map2)
        {
            ...
            opencvunity_imgproc_Imgproc_initUndistortRectifyMap_10(cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj, newCameraMatrix.nativeObj, size.width, size.height, m1type, map1.nativeObj, map2.nativeObj);
        ...
        public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat map1, Mat map2, int projType, double alpha)
        {
            ...
            float retVal = opencvunity_imgproc_Imgproc_initWideAngleProjMap_10(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj, projType, alpha);
        ...
        public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat map1, Mat map2)
        {
            ...
            float retVal = opencvunity_imgproc_Imgproc_initWideAngleProjMap_11(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj);
        ...
        /// <summary>Calculates the integral of an image.</summary>
        ///
        ...
        /// floating-point (32f or 64f).</param>
        ...
        public static void integral(Mat src, Mat sum, int sdepth)
        {
            ...
            opencvunity_imgproc_Imgproc_integral_10(src.nativeObj, sum.nativeObj, sdepth);
        ...
        public static void integral(Mat src, Mat sum)
        {
            ...
            opencvunity_imgproc_Imgproc_integral_11(src.nativeObj, sum.nativeObj);
        ...
        /// double-precision floating-point (64f) array.</param>
        /// <param>sdepth desired depth of the integral and the tilted integral images,
        /// <code>CV_32S</code>, <code>CV_32F</code>, or <code>CV_64F</code>.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/miscellaneous_transformations.html#integral">org.opencv.imgproc.Imgproc.integral</a>
        public static void integral2(Mat src, Mat sum, Mat sqsum, int sdepth)
        {
            ...
            opencvunity_imgproc_Imgproc_integral2_10(src.nativeObj, sum.nativeObj, sqsum.nativeObj, sdepth);
        ...
        ///
        /// <param>src a src</param>
        /// <param>sum integral image as <em>(W+1)x(H+1)</em>, 32-bit integer or</param>
        /// floating-point (32f or 64f).
        /// <param>sqsum integral image for squared pixel values; it is <em>(W+1)x(H+1)</em>,</param>
        ...
        public static void integral2(Mat src, Mat sum, Mat sqsum)
        {
            ...
            opencvunity_imgproc_Imgproc_integral2_11(src.nativeObj, sum.nativeObj, sqsum.nativeObj);
        ...
        /// <em>(W+1)x(H+1)</em> array with the same data type as <code>sum</code>.</param>
        /// <param>sdepth desired depth of the integral and the tilted integral images,
        /// <code>CV_32S</code>, <code>CV_32F</code>, or <code>CV_64F</code>.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/miscellaneous_transformations.html#integral">org.opencv.imgproc.Imgproc.integral</a>
        public static void integral3(Mat src, Mat sum, Mat sqsum, Mat tilted, int sdepth)
        {
            ...
            opencvunity_imgproc_Imgproc_integral3_10(src.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj, sdepth);
        ...
        public static void integral3(Mat src, Mat sum, Mat sqsum, Mat tilted)
        {
            ...
            opencvunity_imgproc_Imgproc_integral3_11(src.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj);
        ...
        public static float intersectConvexConvex(Mat _p1, Mat _p2, Mat _p12, bool handleNested)
        {
            ...
            float retVal = opencvunity_imgproc_Imgproc_intersectConvexConvex_10(_p1.nativeObj, _p2.nativeObj, _p12.nativeObj, handleNested);
        ...
        public static float intersectConvexConvex(Mat _p1, Mat _p2, Mat _p12)
        {
            ...
            float retVal = opencvunity_imgproc_Imgproc_intersectConvexConvex_11(_p1.nativeObj, _p2.nativeObj, _p12.nativeObj);
        ...
        /// <summary>Inverts an affine transformation.</summary>
        ///
        ...
        /// <code>M</code>.</p>
        ///
        /// <param>M Original affine transformation.</param>
        ...
        public static void invertAffineTransform(Mat M, Mat iM)
        {
            ...
            opencvunity_imgproc_Imgproc_invertAffineTransform_10(M.nativeObj, iM.nativeObj);
        ...
        /// <summary>Tests a contour convexity.</summary>
        ///
        ...
        public static bool isContourConvex(MatOfPoint contour)
        {
            ...
            Mat contour_mat = contour;
            bool retVal = opencvunity_imgproc_Imgproc_isContourConvex_10(contour_mat.nativeObj);
        ...
        /// <summary>Compares two shapes.</summary>
        ///
        ...
        /// respectively.</p>
        ///
        /// <param>contour1 a contour1</param>
        /// <param>contour2 a contour2</param>
        /// <param>method Comparison method: <code>CV_CONTOURS_MATCH_I1</code>,
        /// <code>CV_CONTOURS_MATCH_I2</code> \
        /// <p>or <code>CV_CONTOURS_MATCH_I3</code> (see the details below).</p></param>
        ...
        public static double matchShapes(Mat contour1, Mat contour2, int method, double parameter)
        {
            ...
            double retVal = opencvunity_imgproc_Imgproc_matchShapes_10(contour1.nativeObj, contour2.nativeObj, method, parameter);
        ...
        /// <summary>Compares a template against overlapped image regions.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image Image where the search is running. It must be 8-bit or 32-bit</param>
        /// floating-point.
        /// <param>templ Searched template. It must be not greater than the source image</param>
        /// and have the same data type.
        /// <param>result Map of comparison results. It must be single-channel 32-bit</param>
        ...
        /// <param>method Parameter specifying the comparison method (see below).</param>
        ///
        ...
        public static void matchTemplate(Mat image, Mat templ, Mat result, int method)
        {
            ...
            opencvunity_imgproc_Imgproc_matchTemplate_10(image.nativeObj, templ.nativeObj, result.nativeObj, method);
        ...
        /// <summary>Blurs an image using the median filter.</summary>
        ///
        ...
        /// <code>CV_8U</code>.</param>
        /// <param>dst destination array of the same size and type as <code>src</code>.</param>
        /// <param>ksize aperture linear size; it must be odd and greater than 1, for
        /// example: 3, 5, 7...
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#medianblur">org.opencv.imgproc.Imgproc.medianBlur</a>
        /// org.opencv.imgproc.Imgproc#boxFilter
        /// org.opencv.imgproc.Imgproc#GaussianBlur
        /// org.opencv.imgproc.Imgproc#bilateralFilter
        /// org.opencv.imgproc.Imgproc#blur
        public static void medianBlur(Mat src, Mat dst, int ksize)
        {
            ...
            if (ksize % 2 == 0)
                throw new ArgumentException("Median blur : kernel size must be odd");

            opencvunity_imgproc_Imgproc_medianBlur_10(src.nativeObj, dst.nativeObj, ksize);
        ...
        /// <summary>Finds a rotated rectangle of the minimum area enclosing the input 2D point
        /// set.</summary>
        ///
        ...
        public static RotatedRect minAreaRect(MatOfPoint2f points)
        {
            ...
            opencvunity_imgproc_Imgproc_minAreaRect_10(points_mat.nativeObj, tmpArray);
        ...
        /// <summary>Finds a circle of the minimum area enclosing a 2D point set.</summary>
        ///
        ...
        ///   <li> Nx2 numpy array (Python interface)
        /// </ul></param>
        /// <param>center Output center of the circle.</param>
        ...
        public static void minEnclosingCircle(MatOfPoint2f points, Point center, float[] radius)
        {
            ...
            opencvunity_imgproc_Imgproc_minEnclosingCircle_10(points_mat.nativeObj, center_out, radius_out);
            if (center != null)
            {
        ...
        /// <summary>Calculates all of the moments up to the third order of a polygon or
        /// rasterized shape.</p>
        ///
        ...
        ///
        /// <param>array Raster image (single-channel, 8-bit or floating-point 2D array)</param>
        /// or an array (<em>1 x N</em> or <em>N x 1</em>) of 2D points (<code>Point</code>
        /// or <code>Point2f</code>).
        /// <param>binaryImage If it is true, all non-zero image pixels are treated as</param>
        ...
        public static Moments moments(Mat array, bool binaryImage)
        {
            ...
            Moments retVal = new Moments(opencvunity_imgproc_Imgproc_moments_10(array.nativeObj, binaryImage));
        ...
        public static Moments moments(Mat array)
        {
            ...
            Moments retVal = new Moments(opencvunity_imgproc_Imgproc_moments_11(array.nativeObj));
        ...
        /// <summary>Performs advanced morphological transformations.</summary>
        ///
        ...
        /// <code>CV_32F</code> or <code>CV_64F</code>.</param>
        /// <param>dst Destination image of the same size and type as <code>src</code>.</param>
        ...
        /// </ul></param>
        /// <param>kernel a kernel</param>
        /// <param>anchor a anchor</param>
        /// <param>iterations Number of times erosion and dilation are applied.</param>
        /// <param>borderType Pixel extrapolation method. See "borderInterpolate" for
        /// details.</param>
        ...
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#morphologyex">org.opencv.imgproc.Imgproc.morphologyEx</a>
        /// org.opencv.imgproc.Imgproc#erode
        /// org.opencv.imgproc.Imgproc#dilate
        public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_morphologyEx_10(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations)
        {
            ...
            opencvunity_imgproc_Imgproc_morphologyEx_11(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.x, anchor.y, iterations);
        ...
        public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel)
        {
            ...
            opencvunity_imgproc_Imgproc_morphologyEx_12(src.nativeObj, dst.nativeObj, op, kernel.nativeObj);
        ...
        /// <summary>The function is used to detect translational shifts that occur between two
        ...
        /// please see http://en.wikipedia.org/wiki/Phase_correlation.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>src1 Source floating point array (CV_32FC1 or CV_64FC1)</param>
        /// <param>src2 Source floating point array (CV_32FC1 or CV_64FC1)</param>
        ...
        /// org.opencv.imgproc.Imgproc#createHanningWindow
        /// org.opencv.core.Core#dft
        ...
        public static Point phaseCorrelate(Mat src1, Mat src2, Mat window)
        {
            ...
            opencvunity_imgproc_Imgproc_phaseCorrelate_10(src1.nativeObj, src2.nativeObj, window.nativeObj, tmpArray);
        ...
        public static Point phaseCorrelate(Mat src1, Mat src2)
        {
            ...
            opencvunity_imgproc_Imgproc_phaseCorrelate_11(src1.nativeObj, src2.nativeObj, tmpArray);
        ...
        public static Point phaseCorrelateRes(Mat src1, Mat src2, Mat window, double[] response)
        {
            ...
            opencvunity_imgproc_Imgproc_phaseCorrelateRes_10(src1.nativeObj, src2.nativeObj, window.nativeObj, response_out, tmpArray);
        ...
        public static Point phaseCorrelateRes(Mat src1, Mat src2, Mat window)
        {
            ...
            opencvunity_imgproc_Imgproc_phaseCorrelateRes_11(src1.nativeObj, src2.nativeObj, window.nativeObj, tmpArray);
        ...
        /// <summary>Performs a point-in-contour test.</summary>
        ///
        ...
        ///
        /// <param>contour Input contour.</param>
        /// <param>pt Point tested against the contour.</param>
        ...
        public static double pointPolygonTest(MatOfPoint2f contour, Point pt, bool measureDist)
        {
            ...
            Mat contour_mat = contour;
            double retVal = opencvunity_imgproc_Imgproc_pointPolygonTest_10(contour_mat.nativeObj, pt.x, pt.y, measureDist);
        ...
        /// <summary>Calculates a feature map for corner detection.</summary>
        ///
        ...
        /// <p></code></p>
        ///
        /// <param>src Source single-channel 8-bit of floating-point image.</param>
        /// <param>dst Output image that has the type <code>CV_32F</code> and the same
        /// size as <code>src</code>.</param>
        /// <param>ksize Aperture size of the "Sobel".</param>
        /// <param>borderType Pixel extrapolation method. See "borderInterpolate".
        ///
        ...
        public static void preCornerDetect(Mat src, Mat dst, int ksize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_preCornerDetect_10(src.nativeObj, dst.nativeObj, ksize, borderType);
        ...
        public static void preCornerDetect(Mat src, Mat dst, int ksize)
        {
            ...
            opencvunity_imgproc_Imgproc_preCornerDetect_11(src.nativeObj, dst.nativeObj, ksize);
        ...
        /// <summary>Blurs an image and downsamples it.</summary>
        ///
        ...
        ///
        /// <param>src input image.</param>
        /// <param>dst output image; it has the specified size and the same type as</param>
        /// <code>src</code>.
        /// <param>dstsize size of the output image.</param>
        /// <param>borderType Pixel extrapolation method (BORDER_CONSTANT don't</param>
        /// supported). See "borderInterpolate" for details.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#pyrdown">org.opencv.imgproc.Imgproc.pyrDown</a>
        public static void pyrDown(Mat src, Mat dst, Size dstsize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrDown_10(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height, borderType);
        ...
        public static void pyrDown(Mat src, Mat dst, Size dstsize)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrDown_11(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
        ...
        public static void pyrDown(Mat src, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrDown_12(src.nativeObj, dst.nativeObj);
        ...
        /// <summary>Performs initial step of meanshift segmentation of an image.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>src The source 8-bit, 3-channel image.</param>
        /// <param>dst The destination image of the same format and the same size as the
        /// source.</param>
        /// <param>sp The spatial window radius.</param>
        /// <param>sr The color window radius.</param>
        /// <param>maxLevel Maximum level of the pyramid for the segmentation.</param>
        ...
        public static void pyrMeanShiftFiltering(Mat src, Mat dst, double sp, double sr, int maxLevel, TermCriteria termcrit)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrMeanShiftFiltering_10(src.nativeObj, dst.nativeObj, sp, sr, maxLevel, termcrit.type, termcrit.maxCount, termcrit.epsilon);
        ...
        ///
        /// <param>src The source 8-bit, 3-channel image.</param>
        /// <param>dst The destination image of the same format and the same size as the</param>
        /// source.
        /// <param>sp The spatial window radius.</param>
        /// <param>sr The color window radius.</param>
        ///
        ...
        public static void pyrMeanShiftFiltering(Mat src, Mat dst, double sp, double sr)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrMeanShiftFiltering_11(src.nativeObj, dst.nativeObj, sp, sr);
        ...
        /// <summary>Upsamples an image and then blurs it.</summary>
        ///
        ...
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#pyrup">org.opencv.imgproc.Imgproc.pyrUp</a>
        public static void pyrUp(Mat src, Mat dst, Size dstsize, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrUp_10(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height, borderType);
        ...
        public static void pyrUp(Mat src, Mat dst, Size dstsize)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrUp_11(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
        ...
        public static void pyrUp(Mat src, Mat dst)
        {
            ...
            opencvunity_imgproc_Imgproc_pyrUp_12(src.nativeObj, dst.nativeObj);
        ...
        /// <summary>Applies a generic geometrical transformation to an image.</summary>
        ///
        ...
        /// the same type as <code>src</code>.</param>
        ...
        /// <code>map1</code> is <code>(x,y)</code> points), respectively.</param>
        /// <param>interpolation Interpolation method (see "resize"). The method
        /// <code>INTER_AREA</code> is not supported by this function.</param>
        ...
        public static void remap(Mat src, Mat dst, Mat map1, Mat map2, int interpolation, int borderMode, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_remap_10(src.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        public static void remap(Mat src, Mat dst, Mat map1, Mat map2, int interpolation)
        {
            ...
            opencvunity_imgproc_Imgproc_remap_11(src.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation);
        ...
        ///
        /// <param>src input image.</param>
        /// <param>dst output image; it has the size <code>dsize</code> (when it is</param>
        ...
        /// <code>src</code>.
        /// <param>dsize output image size; if it equals zero, it is computed as:</param>
        ///
        ...
        /// non-zero.</p>
        /// <param>fx scale factor along the horizontal axis; when it equals 0, it is</param>
        /// computed as
        ///
        /// <p><em>(double)dsize.width/src.cols</em></p>
        /// <param>fy scale factor along the vertical axis; when it equals 0, it is</param>
        /// computed as
        ///
        /// <p><em>(double)dsize.height/src.rows</em></p>
        /// <param>interpolation interpolation method:</param>
        /// <ul>
        ...
        public static void resize(Mat src, Mat dst, Size dsize, double fx, double fy, int interpolation)
        {
            ...
            opencvunity_imgproc_Imgproc_resize_10(src.nativeObj, dst.nativeObj, dsize.width, dsize.height, fx, fy, interpolation);
        ...
        public static void resize(Mat src, Mat dst, Size dsize)
        {
            ...
            opencvunity_imgproc_Imgproc_resize_11(src.nativeObj, dst.nativeObj, dsize.width, dsize.height);
        ...
        /// <summary>Applies a separable linear filter to an image.</summary>
        ///
        ...
        /// <param>dst Destination image of the same size and the same number of channels</param>
        /// as <code>src</code>.
        /// <param>ddepth Destination image depth. The following combination of</param>
        /// <code>src.depth()</code> and <code>ddepth</code> are supported:
        /// <ul>
        ///   <li> <code>src.depth()</code> = <code>CV_8U</code>, <code>ddepth</code> =
        /// -1/<code>CV_16S</code>/<code>CV_32F</code>/<code>CV_64F</code>
        ...
        /// <p>when <code>ddepth=-1</code>, the destination image will have the same depth
        /// as the source.</p>
        /// <param>kernelX Coefficients for filtering each row.</param>
        /// <param>kernelY Coefficients for filtering each column.</param>
        /// <param>anchor Anchor position within the kernel. The default value</param>
        /// <em>(-1,-1)</em> means that the anchor is at the kernel center.
        /// <param>delta Value added to the filtered results before storing them.</param>
        /// <param>borderType Pixel extrapolation method. See "borderInterpolate" for</param>
        /// details.
        ///
        /// <a href="http://docs.opencv.org/modules/imgproc/doc/filtering.html#sepfilter2d">org.opencv.imgproc.Imgproc.sepFilter2D</a>
        /// org.opencv.imgproc.Imgproc#GaussianBlur
        /// org.opencv.imgproc.Imgproc#Sobel
        /// org.opencv.imgproc.Imgproc#boxFilter
        /// org.opencv.imgproc.Imgproc#blur
        ...
        public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta, int borderType)
        {
            ...
            opencvunity_imgproc_Imgproc_sepFilter2D_10(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.x, anchor.y, delta, borderType);
        ...
        ///
        /// <p>when <code>ddepth=-1</code>, the destination image will have the same depth
        /// as the source.</p></param>
        /// <param>kernelX Coefficients for filtering each row.</param>
        /// <param>kernelY Coefficients for filtering each column.</param>
        /// <param>anchor Anchor position within the kernel. The default value
        /// <em>(-1,-1)</em> means that the anchor is at the kernel center.</param>
        ...
        public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta)
        {
            ...
            opencvunity_imgproc_Imgproc_sepFilter2D_11(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.x, anchor.y, delta);
        ...
        public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY)
        {
            ...
            opencvunity_imgproc_Imgproc_sepFilter2D_12(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj);
        ...
        /// <summary>Applies a fixed-level threshold to each array element.</summary>
        ///
        ...
        ///
        /// <param>src input array (single-channel, 8-bit or 32-bit floating point).</param>
        /// <param>dst output array of the same size and type as <code>src</code>.</param>
        /// <param>thresh threshold value.</param>
        /// <param>maxval maximum value to use with the <code>THRESH_BINARY</code> and</param>
        /// <code>THRESH_BINARY_INV</code> thresholding types.
        /// <param>type thresholding type (see the details below).</param>
        ///
        ...
        public static double threshold(Mat src, Mat dst, double thresh, double maxval, int type)
        {
            ...
            double retVal = opencvunity_imgproc_Imgproc_threshold_10(src.nativeObj, dst.nativeObj, thresh, maxval, type);
        ...
        /// <summary>Transforms an image to compensate for lens distortion.</summary>
        ///
        ...
        /// remain the same.</p>
        ///
        /// <param>src Input (distorted) image.</param>
        ...
        public static void undistort(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix)
        {
            ...
            opencvunity_imgproc_Imgproc_undistort_10(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, newCameraMatrix.nativeObj);
        ...
        public static void undistort(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs)
        {
            ...
            opencvunity_imgproc_Imgproc_undistort_11(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
        ...
        /// <summary>Computes the ideal point coordinates from the observed point coordinates.</summary>
        ///
        ...
        /// <code>dst</code> will contain normalized point coordinates.</param>
        /// <param>cameraMatrix Camera matrix <em>
        /// <p>|f_x 0 c_x|
        /// |0 f_y c_y|
        /// |0 0 1|
        /// </em>.</p></param>
        /// <param>distCoeffs Input vector of distortion coefficients <em>(k_1, k_2, p_1,</param>
        /// p_2[, k_3[, k_4, k_5, k_6]])</em> of 4, 5, or 8 elements. If the vector is
        /// NULL/empty, the zero distortion coefficients are assumed.
        /// <param>R Rectification transformation in the object space (3x3 matrix).</param>
        ...
        /// <param>P New camera matrix (3x3) or new projection matrix (3x4).</param>
        ...
        public static void undistortPoints(MatOfPoint2f src, MatOfPoint2f dst, Mat cameraMatrix, Mat distCoeffs, Mat R, Mat P)
        {
            ...
            Mat src_mat = src;
            Mat dst_mat = dst;
            opencvunity_imgproc_Imgproc_undistortPoints_10(src_mat.nativeObj, dst_mat.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj, P.nativeObj);
        ...
        public static void undistortPoints(MatOfPoint2f src, MatOfPoint2f dst, Mat cameraMatrix, Mat distCoeffs)
        {
            ...
            Mat src_mat = src;
            Mat dst_mat = dst;
            opencvunity_imgproc_Imgproc_undistortPoints_11(src_mat.nativeObj, dst_mat.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
        ...
        public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_warpAffine_10(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize, int flags)
        {
            ...
            opencvunity_imgproc_Imgproc_warpAffine_11(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
        ...
        public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize)
        {
            ...
            opencvunity_imgproc_Imgproc_warpAffine_12(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
        ...
        /// <summary>Applies a perspective transformation to an image.</summary>
        ///
        ...
        /// <param>dst output image that has the size <code>dsize</code> and the same</param>
        /// type as <code>src</code>.
        /// <param>M <em>3x 3</em> transformation matrix.</param>
        /// <param>dsize size of the output image.</param>
        /// <param>flags combination of interpolation methods (<code>INTER_LINEAR</code></param>
        ...
        /// <param>borderMode pixel extrapolation method (<code>BORDER_CONSTANT</code> or</param>
        /// <code>BORDER_REPLICATE</code>).
        /// <param>borderValue value used in case of a constant border; by default, it</param>
        /// equals 0.
        ///
        ...
        public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue)
        {
            ...
            opencvunity_imgproc_Imgproc_warpPerspective_10(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
        ...
        public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize, int flags)
        {
            ...
            opencvunity_imgproc_Imgproc_warpPerspective_11(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
        ...
        public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize)
        {
            ...
            opencvunity_imgproc_Imgproc_warpPerspective_12(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
        ...
        /// <summary>Performs a marker-based image segmentation using the watershed algorithm.</summary>
        ///
        ...
        /// </ul>
        ///
        /// <param>image Input 8-bit 3-channel image.</param>
        ...
        public static void watershed(Mat image, Mat markers)
        {
            ...
            opencvunity_imgproc_Imgproc_watershed_10(image.nativeObj, markers.nativeObj);
        ...
        public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
        {
            ...
            opencvunity_imgproc_Imgproc_rectangle_10(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
        ...
        public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_rectangle_11(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_rectangle_12(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void putText(Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness, int lineType, bool bottomLeftOrigin)
        {
            ...
            opencvunity_imgproc_Imgproc_putText_10(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, bottomLeftOrigin);
        ...
        public static void putText(Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_putText_11(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void putText(Mat img, string text, Point org, int fontFace, double fontScale, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_putText_12(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void polylines(Mat img, List<MatOfPoint> pts, bool isClosed, Scalar color, int thickness, int lineType, int shift)
        {
            ...
            opencvunity_imgproc_Imgproc_polylines_10(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
        ...
        public static void polylines(Mat img, List<MatOfPoint> pts, bool isClosed, Scalar color, int thickness)
        {
            ...
            List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
            Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
            opencvunity_imgproc_Imgproc_polylines_11(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void polylines(Mat img, List<MatOfPoint> pts, bool isClosed, Scalar color)
        {
            ...
            List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
            Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
            opencvunity_imgproc_Imgproc_polylines_12(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
        {
            ...
            opencvunity_imgproc_Imgproc_line_10(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
        ...
        public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_line_11(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void line(Mat img, Point pt1, Point pt2, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_line_12(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void fillConvexPoly(Mat img, MatOfPoint points, Scalar color, int lineType, int shift)
        {
            ...
            Mat points_mat = points;
            opencvunity_imgproc_Imgproc_fillConvexPoly_10(img.nativeObj, points_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift);
        ...
        public static void fillConvexPoly(Mat img, MatOfPoint points, Scalar color)
        {
            ...
            Mat points_mat = points;
            opencvunity_imgproc_Imgproc_fillConvexPoly_11(img.nativeObj, points_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void fillPoly(Mat img, List<MatOfPoint> pts, Scalar color, int lineType, int shift, Point offset)
        {
            ...
            List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
            Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
            opencvunity_imgproc_Imgproc_fillPoly_10(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift, offset.x, offset.y);
        ...
        public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType, int shift)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_10(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
        ...
        public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_11(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_12(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness, int lineType)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_13(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
        ...
        public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_14(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void ellipse(Mat img, RotatedRect box, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_ellipse_15(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, MatOfPoint pts)
        {
            ...
            Mat pts_mat = pts;
            opencvunity_imgproc_Imgproc_ellipse2Poly_10(center.x, center.y, axes.width, axes.height, angle, arcStart, arcEnd, delta, pts_mat.nativeObj);
        ...
        public static void fillPoly(Mat img, List<MatOfPoint> pts, Scalar color)
        {
            ...
            List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
            Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
            opencvunity_imgproc_Imgproc_fillPoly_11(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void circle(Mat img, Point center, int radius, Scalar color, int thickness, int lineType, int shift)
        {
            ...
            opencvunity_imgproc_Imgproc_circle_10(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
        ...
        public static void circle(Mat img, Point center, int radius, Scalar color, int thickness)
        {
            ...
            opencvunity_imgproc_Imgproc_circle_11(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        ...
        public static void circle(Mat img, Point center, int radius, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_circle_12(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3]);
        ...
        public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int line_type, int shift, double tipLength)
        {
            ...
            opencvunity_imgproc_Imgproc_arrowedLine_10(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, line_type, shift, tipLength);
        ...
        public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color)
        {
            ...
            opencvunity_imgproc_Imgproc_arrowedLine_11(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);

        }

        // C++: Size getTextSize(const string& text, int fontFace, double fontScale, int thickness, int* baseLine);

        /// <summary>Calculates the width and height of a text string.</summary>
        ///
        ...
        ///
        /// <param>text Input text string.</param>
        /// <param>fontFace Font to use. See the "putText" for details.</param>
        /// <param>fontScale Font scale. See the "putText" for details.</param>
        ...
        /// the bottom-most text point.</param>
        ///
        ...
        public static Size getTextSize(string text, int fontFace, double fontScale, int thickness, int[] baseLine)
        {
            ...
            double[] tmpArray = new double[2];
            opencvunity_imgproc_Imgproc_n_1getTextSize(text, fontFace, fontScale, thickness, baseLine, tmpArray);
        ...
        private static extern void opencvunity_imgproc_Imgproc_putText_10(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, bool bottomLeftOrigin);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_putText_11(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_putText_12(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void polylines(Mat& img, vector_vector_Point pts, bool isClosed, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_polylines_10(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_polylines_11(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_polylines_12(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void line(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_line_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_line_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_line_12(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void fillPoly(Mat& img, vector_vector_Point pts, Scalar color, int lineType = 8, int shift = 0, Point offset = Point())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fillPoly_10(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift, double offset_x, double offset_y);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fillPoly_11(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void fillConvexPoly(Mat& img, vector_Point points, Scalar color, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fillConvexPoly_10(IntPtr img_nativeObj, IntPtr points_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fillConvexPoly_11(IntPtr img_nativeObj, IntPtr points_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void ellipse(Mat& img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_10(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_11(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_12(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void ellipse(Mat& img, RotatedRect box, Scalar color, int thickness = 1, int lineType = 8)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_13(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_14(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse_15(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, vector_Point& pts)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_ellipse2Poly_10(double center_x, double center_y, double axes_width, double axes_height, int angle, int arcStart, int arcEnd, int delta, IntPtr pts_mat_nativeObj);

        // C++:  void circle(Mat& img, Point center, int radius, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_circle_10(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_circle_11(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_circle_12(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void arrowedLine(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int line_type = 8, int shift = 0, double tipLength = 0.1)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_arrowedLine_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int line_type, int shift, double tipLength);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_arrowedLine_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void rectangle(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_rectangle_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_rectangle_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_rectangle_12(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void Canny(Mat image, Mat& edges, double threshold1, double threshold2, int apertureSize = 3, bool L2gradient = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Canny_10(IntPtr image_nativeObj, IntPtr edges_nativeObj, double threshold1, double threshold2, int apertureSize, bool L2gradient);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Canny_11(IntPtr image_nativeObj, IntPtr edges_nativeObj, double threshold1, double threshold2);

        // C++:  void GaussianBlur(Mat src, Mat& dst, Size ksize, double sigmaX, double sigmaY = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_GaussianBlur_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height, double sigmaX, double sigmaY, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_GaussianBlur_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height, double sigmaX, double sigmaY);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_GaussianBlur_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height, double sigmaX);

        // C++:  void HoughCircles(Mat image, Mat& circles, int method, double dp, double minDist, double param1 = 100, double param2 = 100, int minRadius = 0, int maxRadius = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughCircles_10(IntPtr image_nativeObj, IntPtr circles_nativeObj, int method, double dp, double minDist, double param1, double param2, int minRadius, int maxRadius);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughCircles_11(IntPtr image_nativeObj, IntPtr circles_nativeObj, int method, double dp, double minDist);

        // C++:  void HoughLines(Mat image, Mat& lines, double rho, double theta, int threshold, double srn = 0, double stn = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughLines_10(IntPtr image_nativeObj, IntPtr lines_nativeObj, double rho, double theta, int threshold, double srn, double stn);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughLines_11(IntPtr image_nativeObj, IntPtr lines_nativeObj, double rho, double theta, int threshold);

        // C++:  void HoughLinesP(Mat image, Mat& lines, double rho, double theta, int threshold, double minLineLength = 0, double maxLineGap = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughLinesP_10(IntPtr image_nativeObj, IntPtr lines_nativeObj, double rho, double theta, int threshold, double minLineLength, double maxLineGap);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HoughLinesP_11(IntPtr image_nativeObj, IntPtr lines_nativeObj, double rho, double theta, int threshold);

        // C++:  void HuMoments(Moments m, Mat& hu)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_HuMoments_10(IntPtr m_nativeObj, IntPtr hu_nativeObj);

        // C++:  void Laplacian(Mat src, Mat& dst, int ddepth, int ksize = 1, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Laplacian_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int ksize, double scale, double delta, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Laplacian_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int ksize, double scale, double delta);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Laplacian_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth);

        // C++:  void Scharr(Mat src, Mat& dst, int ddepth, int dx, int dy, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Scharr_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy, double scale, double delta, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Scharr_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy, double scale, double delta);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Scharr_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy);

        // C++:  void Sobel(Mat src, Mat& dst, int ddepth, int dx, int dy, int ksize = 3, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Sobel_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy, int ksize, double scale, double delta, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Sobel_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy, int ksize, double scale, double delta);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_Sobel_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, int dx, int dy);

        // C++:  void accumulate(Mat src, Mat& dst, Mat mask = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulate_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr mask_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulate_11(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void accumulateProduct(Mat src1, Mat src2, Mat& dst, Mat mask = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateProduct_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr dst_nativeObj, IntPtr mask_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateProduct_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr dst_nativeObj);

        // C++:  void accumulateSquare(Mat src, Mat& dst, Mat mask = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateSquare_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr mask_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateSquare_11(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void accumulateWeighted(Mat src, Mat& dst, double alpha, Mat mask = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateWeighted_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double alpha, IntPtr mask_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_accumulateWeighted_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double alpha);

        // C++:  void adaptiveThreshold(Mat src, Mat& dst, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_adaptiveThreshold_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C);

        // C++:  void approxPolyDP(vector_Point2f curve, vector_Point2f& approxCurve, double epsilon, bool closed)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_approxPolyDP_10(IntPtr curve_mat_nativeObj, IntPtr approxCurve_mat_nativeObj, double epsilon, bool closed);

        // C++:  double arcLength(vector_Point2f curve, bool closed)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_arcLength_10(IntPtr curve_mat_nativeObj, bool closed);

        // C++:  void bilateralFilter(Mat src, Mat& dst, int d, double sigmaColor, double sigmaSpace, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_bilateralFilter_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int d, double sigmaColor, double sigmaSpace, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_bilateralFilter_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int d, double sigmaColor, double sigmaSpace);

        // C++:  void blur(Mat src, Mat& dst, Size ksize, Point anchor = Point(-1,-1), int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_blur_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height, double anchor_x, double anchor_y, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_blur_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height, double anchor_x, double anchor_y);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_blur_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, double ksize_width, double ksize_height);
        ...
        // C++:  Rect boundingRect(vector_Point points)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_boundingRect_10(IntPtr points_mat_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] vals);

        // C++:  void boxFilter(Mat src, Mat& dst, int ddepth, Size ksize, Point anchor = Point(-1,-1), bool normalize = true, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_boxFilter_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y, bool normalize, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_boxFilter_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y, bool normalize);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_boxFilter_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, double ksize_width, double ksize_height);

        // C++:  void calcBackProject(vector_Mat images, vector_int channels, Mat hist, Mat& dst, vector_float ranges, double scale)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_calcBackProject_10(IntPtr images_mat_nativeObj, IntPtr channels_mat_nativeObj, IntPtr hist_nativeObj, IntPtr dst_nativeObj, IntPtr ranges_mat_nativeObj, double scale);

        // C++:  void calcHist(vector_Mat images, vector_int channels, Mat mask, Mat& hist, vector_int histSize, vector_float ranges, bool accumulate = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_calcHist_10(IntPtr images_mat_nativeObj, IntPtr channels_mat_nativeObj, IntPtr mask_nativeObj, IntPtr hist_nativeObj, IntPtr histSize_mat_nativeObj, IntPtr ranges_mat_nativeObj, bool accumulate);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_calcHist_11(IntPtr images_mat_nativeObj, IntPtr channels_mat_nativeObj, IntPtr mask_nativeObj, IntPtr hist_nativeObj, IntPtr histSize_mat_nativeObj, IntPtr ranges_mat_nativeObj);

        // C++:  double compareHist(Mat H1, Mat H2, int method)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_compareHist_10(IntPtr H1_nativeObj, IntPtr H2_nativeObj, int method);

        // C++:  double contourArea(Mat contour, bool oriented = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_contourArea_10(IntPtr contour_nativeObj, bool oriented);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_contourArea_11(IntPtr contour_nativeObj);

        // C++:  void convertMaps(Mat map1, Mat map2, Mat& dstmap1, Mat& dstmap2, int dstmap1type, bool nninterpolation = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_convertMaps_10(IntPtr map1_nativeObj, IntPtr map2_nativeObj, IntPtr dstmap1_nativeObj, IntPtr dstmap2_nativeObj, int dstmap1type, bool nninterpolation);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_convertMaps_11(IntPtr map1_nativeObj, IntPtr map2_nativeObj, IntPtr dstmap1_nativeObj, IntPtr dstmap2_nativeObj, int dstmap1type);

        // C++:  void convexHull(vector_Point points, vector_int& hull, bool clockwise = false,  _hidden_  returnPoints = true)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_convexHull_10(IntPtr points_mat_nativeObj, IntPtr hull_mat_nativeObj, bool clockwise);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_convexHull_11(IntPtr points_mat_nativeObj, IntPtr hull_mat_nativeObj);

        // C++:  void convexityDefects(vector_Point contour, vector_int convexhull, vector_Vec4i& convexityDefects)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_convexityDefects_10(IntPtr contour_mat_nativeObj, IntPtr convexhull_mat_nativeObj, IntPtr convexityDefects_mat_nativeObj);

        // C++:  void cornerEigenValsAndVecs(Mat src, Mat& dst, int blockSize, int ksize, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerEigenValsAndVecs_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerEigenValsAndVecs_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize);

        // C++:  void cornerHarris(Mat src, Mat& dst, int blockSize, int ksize, double k, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerHarris_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize, double k, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerHarris_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize, double k);

        // C++:  void cornerMinEigenVal(Mat src, Mat& dst, int blockSize, int ksize = 3, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerMinEigenVal_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerMinEigenVal_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize, int ksize);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerMinEigenVal_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int blockSize);

        // C++:  void cornerSubPix(Mat image, vector_Point2f& corners, Size winSize, Size zeroZone, TermCriteria criteria)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cornerSubPix_10(IntPtr image_nativeObj, IntPtr corners_mat_nativeObj, double winSize_width, double winSize_height, double zeroZone_width, double zeroZone_height, int criteria_type, int criteria_maxCount, double criteria_epsilon);

        // C++:  void createHanningWindow(Mat& dst, Size winSize, int type)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_createHanningWindow_10(IntPtr dst_nativeObj, double winSize_width, double winSize_height, int type);

        // C++:  void cvtColor(Mat src, Mat& dst, int code, int dstCn = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cvtColor_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int code, int dstCn);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_cvtColor_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int code);

        // C++:  void dilate(Mat src, Mat& dst, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_dilate_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_dilate_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_dilate_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj);

        // C++:  void distanceTransform(Mat src, Mat& dst, int distanceType, int maskSize)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_distanceTransform_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int distanceType, int maskSize);

        // C++:  void distanceTransform(Mat src, Mat& dst, Mat& labels, int distanceType, int maskSize, int labelType = DIST_LABEL_CCOMP)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_distanceTransformWithLabels_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr labels_nativeObj, int distanceType, int maskSize, int labelType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_distanceTransformWithLabels_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr labels_nativeObj, int distanceType, int maskSize);

        // C++:  void drawContours(Mat& image, vector_vector_Point contours, int contourIdx, Scalar color, int thickness = 1, int lineType = 8, Mat hierarchy = Mat(), int maxLevel = INT_MAX, Point offset = Point())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_drawContours_10(IntPtr image_nativeObj, IntPtr contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, IntPtr hierarchy_nativeObj, int maxLevel, double offset_x, double offset_y);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_drawContours_11(IntPtr image_nativeObj, IntPtr contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_drawContours_12(IntPtr image_nativeObj, IntPtr contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3);

        // C++:  void equalizeHist(Mat src, Mat& dst)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_equalizeHist_10(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void erode(Mat src, Mat& dst, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_erode_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_erode_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_erode_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr kernel_nativeObj);

        // C++:  void filter2D(Mat src, Mat& dst, int ddepth, Mat kernel, Point anchor = Point(-1,-1), double delta = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_filter2D_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, double delta, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_filter2D_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, double delta);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_filter2D_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernel_nativeObj);

        // C++:  void findContours(Mat& image, vector_vector_Point& contours, Mat& hierarchy, int mode, int method, Point offset = Point())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_findContours_10(IntPtr image_nativeObj, IntPtr contours_mat_nativeObj, IntPtr hierarchy_nativeObj, int mode, int method, double offset_x, double offset_y);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_findContours_11(IntPtr image_nativeObj, IntPtr contours_mat_nativeObj, IntPtr hierarchy_nativeObj, int mode, int method);

        // C++:  RotatedRect fitEllipse(vector_Point2f points)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fitEllipse_10(IntPtr points_mat_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 5)] double[] vals);

        // C++:  void fitLine(Mat points, Mat& line, int distType, double param, double reps, double aeps)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_fitLine_10(IntPtr points_nativeObj, IntPtr line_nativeObj, int distType, double param, double reps, double aeps);

        // C++:  int floodFill(Mat& image, Mat& mask, Point seedPoint, Scalar newVal, Rect* rect = 0, Scalar loDiff = Scalar(), Scalar upDiff = Scalar(), int flags = 4)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern int opencvunity_imgproc_Imgproc_floodFill_10(IntPtr image_nativeObj, IntPtr mask_nativeObj, double seedPoint_x, double seedPoint_y, double newVal_val0, double newVal_val1, double newVal_val2, double newVal_val3, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] rect_out, double loDiff_val0, double loDiff_val1, double loDiff_val2, double loDiff_val3, double upDiff_val0, double upDiff_val1, double upDiff_val2, double upDiff_val3, int flags);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern int opencvunity_imgproc_Imgproc_floodFill_11(IntPtr image_nativeObj, IntPtr mask_nativeObj, double seedPoint_x, double seedPoint_y, double newVal_val0, double newVal_val1, double newVal_val2, double newVal_val3);

        // C++:  Mat getAffineTransform(vector_Point2f src, vector_Point2f dst)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getAffineTransform_10(IntPtr src_mat_nativeObj, IntPtr dst_mat_nativeObj);

        // C++:  Mat getDefaultNewCameraMatrix(Mat cameraMatrix, Size imgsize = Size(), bool centerPrincipalPoint = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getDefaultNewCameraMatrix_10(IntPtr cameraMatrix_nativeObj, double imgsize_width, double imgsize_height, bool centerPrincipalPoint);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getDefaultNewCameraMatrix_11(IntPtr cameraMatrix_nativeObj);

        // C++:  void getDerivKernels(Mat& kx, Mat& ky, int dx, int dy, int ksize, bool normalize = false, int ktype = CV_32F)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_getDerivKernels_10(IntPtr kx_nativeObj, IntPtr ky_nativeObj, int dx, int dy, int ksize, bool normalize, int ktype);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_getDerivKernels_11(IntPtr kx_nativeObj, IntPtr ky_nativeObj, int dx, int dy, int ksize);

        // C++:  Mat getGaborKernel(Size ksize, double sigma, double theta, double lambd, double gamma, double psi = CV_PI*0.5, int ktype = CV_64F)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getGaborKernel_10(double ksize_width, double ksize_height, double sigma, double theta, double lambd, double gamma, double psi, int ktype);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getGaborKernel_11(double ksize_width, double ksize_height, double sigma, double theta, double lambd, double gamma);

        // C++:  Mat getGaussianKernel(int ksize, double sigma, int ktype = CV_64F)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getGaussianKernel_10(int ksize, double sigma, int ktype);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getGaussianKernel_11(int ksize, double sigma);

        // C++:  Mat getPerspectiveTransform(Mat src, Mat dst)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getPerspectiveTransform_10(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void getRectSubPix(Mat image, Size patchSize, Point2f center, Mat& patch, int patchType = -1)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_getRectSubPix_10(IntPtr image_nativeObj, double patchSize_width, double patchSize_height, double center_x, double center_y, IntPtr patch_nativeObj, int patchType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_getRectSubPix_11(IntPtr image_nativeObj, double patchSize_width, double patchSize_height, double center_x, double center_y, IntPtr patch_nativeObj);

        // C++:  Mat getRotationMatrix2D(Point2f center, double angle, double scale)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getRotationMatrix2D_10(double center_x, double center_y, double angle, double scale);

        // C++:  Mat getStructuringElement(int shape, Size ksize, Point anchor = Point(-1,-1))
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getStructuringElement_10(int shape, double ksize_width, double ksize_height, double anchor_x, double anchor_y);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_getStructuringElement_11(int shape, double ksize_width, double ksize_height);

        // C++:  void goodFeaturesToTrack(Mat image, vector_Point& corners, int maxCorners, double qualityLevel, double minDistance, Mat mask = Mat(), int blockSize = 3, bool useHarrisDetector = false, double k = 0.04)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_goodFeaturesToTrack_10(IntPtr image_nativeObj, IntPtr corners_mat_nativeObj, int maxCorners, double qualityLevel, double minDistance, IntPtr mask_nativeObj, int blockSize, bool useHarrisDetector, double k);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_goodFeaturesToTrack_11(IntPtr image_nativeObj, IntPtr corners_mat_nativeObj, int maxCorners, double qualityLevel, double minDistance);

        // C++:  void grabCut(Mat img, Mat& mask, Rect rect, Mat& bgdModel, Mat& fgdModel, int iterCount, int mode = GC_EVAL)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_grabCut_10(IntPtr img_nativeObj, IntPtr mask_nativeObj, int rect_x, int rect_y, int rect_width, int rect_height, IntPtr bgdModel_nativeObj, IntPtr fgdModel_nativeObj, int iterCount, int mode);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_grabCut_11(IntPtr img_nativeObj, IntPtr mask_nativeObj, int rect_x, int rect_y, int rect_width, int rect_height, IntPtr bgdModel_nativeObj, IntPtr fgdModel_nativeObj, int iterCount);

        // C++:  void initUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix, Size size, int m1type, Mat& map1, Mat& map2)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_initUndistortRectifyMap_10(IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, IntPtr R_nativeObj, IntPtr newCameraMatrix_nativeObj, double size_width, double size_height, int m1type, IntPtr map1_nativeObj, IntPtr map2_nativeObj);

        // C++:  float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat& map1, Mat& map2, int projType = PROJ_SPHERICAL_EQRECT, double alpha = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern float opencvunity_imgproc_Imgproc_initWideAngleProjMap_10(IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, IntPtr map1_nativeObj, IntPtr map2_nativeObj, int projType, double alpha);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern float opencvunity_imgproc_Imgproc_initWideAngleProjMap_11(IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, IntPtr map1_nativeObj, IntPtr map2_nativeObj);

        // C++:  void integral(Mat src, Mat& sum, int sdepth = -1)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral_10(IntPtr src_nativeObj, IntPtr sum_nativeObj, int sdepth);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral_11(IntPtr src_nativeObj, IntPtr sum_nativeObj);

        // C++:  void integral(Mat src, Mat& sum, Mat& sqsum, int sdepth = -1)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral2_10(IntPtr src_nativeObj, IntPtr sum_nativeObj, IntPtr sqsum_nativeObj, int sdepth);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral2_11(IntPtr src_nativeObj, IntPtr sum_nativeObj, IntPtr sqsum_nativeObj);

        // C++:  void integral(Mat src, Mat& sum, Mat& sqsum, Mat& tilted, int sdepth = -1)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral3_10(IntPtr src_nativeObj, IntPtr sum_nativeObj, IntPtr sqsum_nativeObj, IntPtr tilted_nativeObj, int sdepth);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_integral3_11(IntPtr src_nativeObj, IntPtr sum_nativeObj, IntPtr sqsum_nativeObj, IntPtr tilted_nativeObj);

        // C++:  float intersectConvexConvex(Mat _p1, Mat _p2, Mat& _p12, bool handleNested = true)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern float opencvunity_imgproc_Imgproc_intersectConvexConvex_10(IntPtr _p1_nativeObj, IntPtr _p2_nativeObj, IntPtr _p12_nativeObj, bool handleNested);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern float opencvunity_imgproc_Imgproc_intersectConvexConvex_11(IntPtr _p1_nativeObj, IntPtr _p2_nativeObj, IntPtr _p12_nativeObj);

        // C++:  void invertAffineTransform(Mat M, Mat& iM)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_invertAffineTransform_10(IntPtr M_nativeObj, IntPtr iM_nativeObj);

        // C++:  bool isContourConvex(vector_Point contour)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_imgproc_Imgproc_isContourConvex_10(IntPtr contour_mat_nativeObj);

        // C++:  double matchShapes(Mat contour1, Mat contour2, int method, double parameter)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_matchShapes_10(IntPtr contour1_nativeObj, IntPtr contour2_nativeObj, int method, double parameter);

        // C++:  void matchTemplate(Mat image, Mat templ, Mat& result, int method)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_matchTemplate_10(IntPtr image_nativeObj, IntPtr templ_nativeObj, IntPtr result_nativeObj, int method);

        // C++:  void medianBlur(Mat src, Mat& dst, int ksize)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_medianBlur_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ksize);

        // C++:  RotatedRect minAreaRect(vector_Point2f points)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_minAreaRect_10(IntPtr points_mat_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 5)] double[] vals);

        // C++:  void minEnclosingCircle(vector_Point2f points, Point2f& center, float& radius)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_minEnclosingCircle_10(IntPtr points_mat_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] center_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] radius_out);

        // C++:  Moments moments(Mat array, bool binaryImage = false)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_moments_10(IntPtr array_nativeObj, bool binaryImage);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_imgproc_Imgproc_moments_11(IntPtr array_nativeObj);

        // C++:  void morphologyEx(Mat src, Mat& dst, int op, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_morphologyEx_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int op, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_morphologyEx_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int op, IntPtr kernel_nativeObj, double anchor_x, double anchor_y, int iterations);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_morphologyEx_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int op, IntPtr kernel_nativeObj);

        // C++:  Point2d phaseCorrelate(Mat src1, Mat src2, Mat window = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_phaseCorrelate_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_phaseCorrelate_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);

        // C++:  Point2d phaseCorrelateRes(Mat src1, Mat src2, Mat window, double* response = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_phaseCorrelateRes_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] response_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_phaseCorrelateRes_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);

        // C++:  double pointPolygonTest(vector_Point2f contour, Point2f pt, bool measureDist)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_pointPolygonTest_10(IntPtr contour_mat_nativeObj, double pt_x, double pt_y, bool measureDist);

        // C++:  void preCornerDetect(Mat src, Mat& dst, int ksize, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_preCornerDetect_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ksize, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_preCornerDetect_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ksize);

        // C++:  void pyrDown(Mat src, Mat& dst, Size dstsize = Size(), int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrDown_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dstsize_width, double dstsize_height, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrDown_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dstsize_width, double dstsize_height);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrDown_12(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void pyrMeanShiftFiltering(Mat src, Mat& dst, double sp, double sr, int maxLevel = 1, TermCriteria termcrit = TermCriteria( TermCriteria::MAX_ITER+TermCriteria::EPS,5,1))
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrMeanShiftFiltering_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double sp, double sr, int maxLevel, int termcrit_type, int termcrit_maxCount, double termcrit_epsilon);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrMeanShiftFiltering_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double sp, double sr);

        // C++:  void pyrUp(Mat src, Mat& dst, Size dstsize = Size(), int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrUp_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dstsize_width, double dstsize_height, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrUp_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dstsize_width, double dstsize_height);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_pyrUp_12(IntPtr src_nativeObj, IntPtr dst_nativeObj);

        // C++:  void remap(Mat src, Mat& dst, Mat map1, Mat map2, int interpolation, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_remap_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr map1_nativeObj, IntPtr map2_nativeObj, int interpolation, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_remap_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr map1_nativeObj, IntPtr map2_nativeObj, int interpolation);

        // C++:  void resize(Mat src, Mat& dst, Size dsize, double fx = 0, double fy = 0, int interpolation = INTER_LINEAR)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_resize_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dsize_width, double dsize_height, double fx, double fy, int interpolation);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_resize_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, double dsize_width, double dsize_height);

        // C++:  void sepFilter2D(Mat src, Mat& dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor = Point(-1,-1), double delta = 0, int borderType = BORDER_DEFAULT)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_sepFilter2D_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernelX_nativeObj, IntPtr kernelY_nativeObj, double anchor_x, double anchor_y, double delta, int borderType);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_sepFilter2D_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernelX_nativeObj, IntPtr kernelY_nativeObj, double anchor_x, double anchor_y, double delta);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_sepFilter2D_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, int ddepth, IntPtr kernelX_nativeObj, IntPtr kernelY_nativeObj);

        // C++:  double threshold(Mat src, Mat& dst, double thresh, double maxval, int type)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_imgproc_Imgproc_threshold_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, double thresh, double maxval, int type);

        // C++:  void undistort(Mat src, Mat& dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_undistort_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, IntPtr newCameraMatrix_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_undistort_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj);

        // C++:  void undistortPoints(vector_Point2f src, vector_Point2f& dst, Mat cameraMatrix, Mat distCoeffs, Mat R = Mat(), Mat P = Mat())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_undistortPoints_10(IntPtr src_mat_nativeObj, IntPtr dst_mat_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, IntPtr R_nativeObj, IntPtr P_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_undistortPoints_11(IntPtr src_mat_nativeObj, IntPtr dst_mat_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj);

        // C++:  void warpAffine(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpAffine_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpAffine_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height, int flags);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpAffine_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height);

        // C++:  void warpPerspective(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpPerspective_10(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpPerspective_11(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height, int flags);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_warpPerspective_12(IntPtr src_nativeObj, IntPtr dst_nativeObj, IntPtr M_nativeObj, double dsize_width, double dsize_height);

        // C++:  void watershed(Mat image, Mat& markers)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_watershed_10(IntPtr image_nativeObj, IntPtr markers_nativeObj);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_imgproc_Imgproc_n_1getTextSize(string text, int fontFace, double fontScale, int thickness, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] int[] baseLine, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);
    }}