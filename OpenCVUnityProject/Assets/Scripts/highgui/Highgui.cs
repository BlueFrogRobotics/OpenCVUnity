...
namespace OpenCVUnity{
    public class Highgui
    {
        ...
        public static Mat imdecode(Mat buf, int flags)
        {
            ...
            Mat retVal = new Mat(opencvunity_highgui_Highgui_imdecode_10(buf.nativeObj, flags));
        ...
        public static bool imencode(string ext, Mat img, MatOfByte buf, MatOfInt _params)
        {
            ...
            bool retVal = opencvunity_highgui_Highgui_imencode_10(ext, img.nativeObj, buf_mat.nativeObj, params_mat.nativeObj);
        ...
        public static bool imencode(string ext, Mat img, MatOfByte buf)
        {
            ...
            Mat buf_mat = buf;
            bool retVal = opencvunity_highgui_Highgui_imencode_11(ext, img.nativeObj, buf_mat.nativeObj);
        ...
        /// stored in <code>B G R</code> order.</p>
        ///
        /// <param>filename Name of file to be loaded.</param>
        ...
        /// </ul></param>
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#imread">org.opencv.highgui.Highgui.imread</a>
        public static Mat imread(string filename, int flags)
        {
            Mat retVal = new Mat(opencvunity_highgui_Highgui_imread_10(filename, flags));
        ...
        {
            Mat retVal = new Mat(opencvunity_highgui_Highgui_imread_11(filename));
        ...
        /// <summary>Saves an image to a specified file.</summary>
        ///
        ...
        ///
        ///
        /// <param>filename Name of the file.</param>
        /// <param>img a img</param>
        ...
        /// </ul></param>
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#imwrite">org.opencv.highgui.Highgui.imwrite</a>
        public static bool imwrite(string filename, Mat img, MatOfInt _params)
        {
            ...
            Mat params_mat = _params;
            bool retVal = opencvunity_highgui_Highgui_imwrite_10(filename, img.nativeObj, params_mat.nativeObj);
        ...
        public static bool imwrite(string filename, Mat img)
        {
            ...
            bool retVal = opencvunity_highgui_Highgui_imwrite_11(filename, img.nativeObj);

            return retVal;
        }

        // C++:  Mat imdecode(Mat buf, int flags)
        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern IntPtr opencvunity_highgui_Highgui_imdecode_10(IntPtr buf_nativeObj, int flags);

        // C++:  bool imencode(string ext, Mat img, vector_uchar& buf, vector_int params = vector<int>())
        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern bool opencvunity_highgui_Highgui_imencode_10(string ext, IntPtr img_nativeObj, IntPtr buf_mat_nativeObj, IntPtr params_mat_nativeObj);

        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern bool opencvunity_highgui_Highgui_imencode_11(string ext, IntPtr img_nativeObj, IntPtr buf_mat_nativeObj);

        // C++:  Mat imread(string filename, int flags = 1)
        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern IntPtr opencvunity_highgui_Highgui_imread_10(string filename, int flags);

        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern IntPtr opencvunity_highgui_Highgui_imread_11(string filename);

        // C++:  bool imwrite(string filename, Mat img, vector_int params = vector<int>())
        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern bool opencvunity_highgui_Highgui_imwrite_10(string filename, IntPtr img_nativeObj, IntPtr params_mat_nativeObj);

        [DllImport("opencvunity", CharSet = CharSet.Ansi)]
        private static extern bool opencvunity_highgui_Highgui_imwrite_11(string filename, IntPtr img_nativeObj);
