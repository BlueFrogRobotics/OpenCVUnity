using System;using System.Linq;using UnityEngine;namespace OpenCVUnity{
    /// <summary>Template class for a 4-element vector derived from Vec.</summary>
    ///
    ...
    /// </code></p>
    ///
    /// <a href="http://docs.opencv.org/modules/core/doc/basic_structures.html#scalar">org.opencv.core.Scalar_</a>
    public class Scalar
    {

        public double[] val;

        public Scalar(Color32 col)
        {
            val = new double[] { col.r, col.g, col.b, col.a };
        }

        public Scalar(Color col)
        {
            val = new double[] { col.r, col.g, col.b, col.a };
        }
        ...
        {
            return new Color((float)val[0], (float)val[1], (float)val[2], (float)val[3]);
        }

        public Color32 toColor32()
        {
            return new Color32((byte)val[0], (byte)val[1], (byte)val[2], (byte)val[3]);
        }
        ...
        public override int GetHashCode()
        {
            ...
            result = prime * result + Hash.HashContents(val);
            return result;
        }
