using System;using UnityEngine;namespace OpenCVUnity{
    /// <summary>template<typename _Tp> class CV_EXPORTS Rect_ <code></summary>
    ///
    /// <p>// C++ code:</p>
    ///
    ///
    ...
    ///
    /// <a href="http://docs.opencv.org/modules/core/doc/basic_structures.html#rect">org.opencv.core.Rect_</a>
    public class Rect
    {
        ...
        public Rect(UnityEngine.Rect iRect)
        {
            this.x = (int)iRect.x;
            this.y = (int)iRect.y;
            this.width = (int)iRect.width;
            this.height = (int)iRect.height;
        }
