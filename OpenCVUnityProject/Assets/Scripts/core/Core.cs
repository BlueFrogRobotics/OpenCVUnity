...
/// OpenCV API. The API is link to the CPP version of OpenCV. For C# wrappers, see OpenCVJava Doc.
/// </summary>namespace OpenCVUnity{
    ...
    public class Core
    {
        ...
        public static void gemm(Mat src1, Mat src2, double alpha, Mat src3, double beta, Mat dst, int flags)
        {
            ...
            if (src3 == null)
                src3 = new Mat(src1.rows(), src2.cols(), src1.type());
        ...
        /// org.opencv.core.Core#mulTransposed
        /// org.opencv.core.Core#transform
        public static void gemm(Mat src1, Mat src2, Mat dst)
        {
            if (src1 != null)
                src1.ThrowIfDisposed();
            if (src2 != null)
            ...
            Mat src3 = new Mat(src1.rows(), src2.cols(), src1.type());

            opencvunity_core_Core_gemm_11(src1.nativeObj, src2.nativeObj, 1, src3.nativeObj, 0, dst.nativeObj);
        }
