using System;using System.Runtime.InteropServices;using System.Collections.Generic;using System.IO;namespace OpenCVUnity{
    ...
    /// <summary>Class for video capturing from video files or cameras.
    /// The class provides C++ API for capturing video from cameras or for reading
    /// video files. Here is how the class can be used:</summary>
    ///
    ...
    /// </ul>
    ///
    /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#videocapture">org.opencv.highgui.VideoCapture</a>
    public class VideoCapture : DisposableOpenCVObject
    {
            ...
            try
            {
                ...
                if (IsEnabledDispose)
                {
                    if (nativeObj != IntPtr.Zero)
                        opencvunity_highgui_VideoCapture_n_1delete(nativeObj);
        ...
        /// <summary>VideoCapture constructors.</summary>
        ///
        ...
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#videocapture-videocapture">org.opencv.highgui.VideoCapture.VideoCapture</a>
        public VideoCapture()
        {
            nativeObj = opencvunity_highgui_VideoCapture_n_1VideoCapture__();
        }
        ...
        public VideoCapture(string filename)
        {
            ...
            nativeObj = opencvunity_highgui_VideoCapture_n_VideoCapture(filename);
        ...
        /// If there is a single camera connected, just pass 0.</param>
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#videocapture-videocapture">org.opencv.highgui.VideoCapture.VideoCapture</a>
        public VideoCapture(int device)
        {
            nativeObj = opencvunity_highgui_VideoCapture_n_1VideoCapture__I(device);
        }
        ...
        /// <summary>Returns the specified <code>VideoCapture</code> property</summary>
        ///
        ...
        ///
        /// <param>propId Property identifier. It can be one of the following:</param>
        /// <ul>
        ...
        /// </ul>
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#videocapture-get">org.opencv.highgui.VideoCapture.get</a>
        public double get(int propId)
        {
            ThrowIfDisposed();

            double retVal = opencvunity_highgui_VideoCapture_n_1get(nativeObj, propId);
        ...
        public List<Size> getSupportedPreviewSizes()
        {
            ...
            string[] sizes_str = Marshal.PtrToStringAnsi(opencvunity_highgui_VideoCapture_n_1getSupportedPreviewSizes(nativeObj)).Split(',');
        ...
        public bool grab()
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1grab(nativeObj);
        ...
        public bool isOpened()
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1isOpened(nativeObj);
        ...
        public bool open(string filename)
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_open(nativeObj, filename);
        ...
        public bool open(int device)
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1open__JI(nativeObj, device);
        ...
        public bool read(Mat image)
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1read(nativeObj, image.nativeObj);
        ...
        public void release()
        {
            ...
            opencvunity_highgui_VideoCapture_n_1release(nativeObj);
        ...
        public bool retrieve(Mat image, int channel)
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1retrieve__JJI(nativeObj, image.nativeObj, channel);
        ...
        public bool retrieve(Mat image)
        {
            ...
            bool retVal = opencvunity_highgui_VideoCapture_n_1retrieve__JJ(nativeObj, image.nativeObj);
        ...
        /// <summary>Sets a property in the <code>VideoCapture</code>.</summary>
        ///
        ...
        /// only supported by DC1394 v 2.x backend currently)
        /// </ul></param>
        /// <param>value Value of the property.</param>
        ///
        /// <a href="http://docs.opencv.org/modules/highgui/doc/reading_and_writing_images_and_video.html#videocapture-set">org.opencv.highgui.VideoCapture.set</a>
        public bool set(int propId, double value)
        {
            ThrowIfDisposed();

            bool retVal = opencvunity_highgui_VideoCapture_n_1set(nativeObj, propId, value);
        ...
        private static extern IntPtr opencvunity_highgui_VideoCapture_n_1VideoCapture__();

        // C++: VideoCapture::VideoCapture(string filename)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_highgui_VideoCapture_n_VideoCapture(string filename);

        // C++: VideoCapture::VideoCapture(int device)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_highgui_VideoCapture_n_1VideoCapture__I(int device);

        // C++: double VideoCapture::get(int propId)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern double opencvunity_highgui_VideoCapture_n_1get(IntPtr nativeObj, int propId);

        // C++: bool VideoCapture::grab()
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1grab(IntPtr nativeObj);

        // C++: bool VideoCapture::isOpened()
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1isOpened(IntPtr nativeObj);

        // C++: bool VideoCapture::open(string filename)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_open(IntPtr nativeObj, string filename);

        // C++: bool VideoCapture::open(int device)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1open__JI(IntPtr nativeObj, int device);

        // C++: bool VideoCapture::read(Mat image)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1read(IntPtr nativeObj, IntPtr image_nativeObj);

        // C++: void VideoCapture::release()
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_highgui_VideoCapture_n_1release(IntPtr nativeObj);

        // C++: bool VideoCapture::retrieve(Mat image, int channel = 0)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1retrieve__JJI(IntPtr nativeObj, IntPtr image_nativeObj, int channel);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1retrieve__JJ(IntPtr nativeObj, IntPtr image_nativeObj);

        // C++: bool VideoCapture::set(int propId, double value)
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool opencvunity_highgui_VideoCapture_n_1set(IntPtr nativeObj, int propId, double value);

        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr opencvunity_highgui_VideoCapture_n_1getSupportedPreviewSizes(IntPtr nativeObj);

        // native support for java finalize()
        [DllImport("opencvunity", CallingConvention = CallingConvention.Cdecl)]
        private static extern void opencvunity_highgui_VideoCapture_n_1delete(IntPtr nativeObj);
    }}