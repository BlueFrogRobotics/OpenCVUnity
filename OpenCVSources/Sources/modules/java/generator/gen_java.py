...
# "simple"  : { j_type : "?", jn_type : "?", jni_type : "?", suffix : "?" },
    ""        : { "j_type" : "", "jn_type" : "long", "jni_type" : "jlong" , "csharp_type" : "void", "csharpn_type" : "IntPtr"}, # c-tor ret_type
    "void"    : { "j_type" : "void", "jn_type" : "void", "jni_type" : "void" , "csharp_type" : "void", "csharpn_type" : "void"},
    "env"     : { "j_type" : "", "jn_type" : "", "jni_type" : "JNIEnv*", "csharp_type" : "env", "csharpn_type" : ""},
    "cls"     : { "j_type" : "", "jn_type" : "", "jni_type" : "jclass", "csharp_type" : "", "csharpn_type" : "IntPtr"},
    "bool"    : { "j_type" : "boolean", "jn_type" : "boolean", "jni_type" : "jboolean", "suffix" : "Z" , "csharp_type" : "bool", "csharpn_type" : "bool"},
    "char"    : { "j_type" : "char", "jn_type" : "char", "jni_type" : "jchar", "suffix" : "C" , "csharp_type" : "char", "csharpn_type" : "char"},
    "int"     : { "j_type" : "int", "jn_type" : "int", "jni_type" : "jint", "suffix" : "I", "csharp_type" : "int" , "csharpn_type" : "int"},
    "long"    : { "j_type" : "int", "jn_type" : "int", "jni_type" : "jint", "suffix" : "I" , "csharp_type" : "long", "csharpn_type" : "long"},
    "float"   : { "j_type" : "float", "jn_type" : "float", "jni_type" : "jfloat", "suffix" : "F" , "csharp_type" : "float", "csharpn_type" : "float"},
    "double"  : { "j_type" : "double", "jn_type" : "double", "jni_type" : "jdouble", "suffix" : "D" , "csharp_type" : "double", "csharpn_type" : "double"},
    "size_t"  : { "j_type" : "long", "jn_type" : "long", "jni_type" : "jlong", "suffix" : "J" , "csharp_type" : "size_t", "csharpn_type" : "IntPtr"},
    "__int64" : { "j_type" : "long", "jn_type" : "long", "jni_type" : "jlong", "suffix" : "J" , "csharp_type" : "Mat*", "csharpn_type" : "IntPtr"},
    "int64"   : { "j_type" : "long", "jn_type" : "long", "jni_type" : "jlong", "suffix" : "J" , "csharp_type" : "long", "csharpn_type" : "IntPtr"},
    "double[]": { "j_type" : "double[]", "jn_type" : "double[]", "jni_type" : "jdoubleArray", "suffix" : "_3D" , "csharp_type" : "double*", "csharpn_type" : "double[]"},

# "complex" : { j_type : "?", jn_args : (("", ""),), jn_name : "", jni_var : "", jni_name : "", "suffix" : "?" },

    "vector_Point"    : { "j_type" : "MatOfPoint", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point> %(n)s", "suffix" : "J", "csharp_type" : "void", "csharp_var" : "std::vector<Point> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Point2f"  : { "j_type" : "MatOfPoint2f", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point2f> %(n)s", "suffix" : "J" , "csharp_type" : "void","csharp_var" : "std::vector<Point2f> %(n)s", "csharpn_type" : "IntPtr"},
    #"vector_Point2d"  : { "j_type" : "MatOfPoint2d", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point2d> %(n)s", "suffix" : "J" },
    "vector_Point3i"  : { "j_type" : "MatOfPoint3", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point3i> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Point3i> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Point3f"  : { "j_type" : "MatOfPoint3f", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point3f> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Point3f> %(n)s", "csharpn_type" : "IntPtr"},
    #"vector_Point3d"  : { "j_type" : "MatOfPoint3d", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Point3d> %(n)s", "suffix" : "J" },
    "vector_KeyPoint" : { "j_type" : "MatOfKeyPoint", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<KeyPoint> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<KeyPoint> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_DMatch"   : { "j_type" : "MatOfDMatch", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<DMatch> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<DMatch> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Rect"     : { "j_type" : "MatOfRect",   "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Rect> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Rect> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_uchar"    : { "j_type" : "MatOfByte",   "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<uchar> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<uchar> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_char"     : { "j_type" : "MatOfByte",   "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<char> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<char> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_int"      : { "j_type" : "MatOfInt",    "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<int> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<int> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_float"    : { "j_type" : "MatOfFloat",  "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<float> %(n)s", "suffix" : "J" , "csharp_type" : "Mat*", "csharp_var" : "std::vector<float> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_double"   : { "j_type" : "MatOfDouble", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<double> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<double> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Vec4i"    : { "j_type" : "MatOfInt4",    "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Vec4i> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Vec4i> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Vec4f"    : { "j_type" : "MatOfFloat4",  "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Vec4f> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Vec4f> %(n)s", "csharpn_type" : "IntPtr"},
    "vector_Vec6f"    : { "j_type" : "MatOfFloat6",  "jn_type" : "long", "jni_type" : "jlong ", "jni_var" : "std::vector<Vec6f> %(n)s", "suffix" : "J" , "csharp_type" : "void", "csharp_var" : "std::vector<Vec6f> %(n)s", "csharpn_type" : "IntPtr"},

    "vector_Mat"      : { "j_type" : "List<Mat>",   "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector<Mat> %(n)s", "suffix" : "J" , "csharp_type" : "Mat*", "csharp_var" : "std::vector<Mat> %(n)s", "csharpn_type" : "IntPtr"},

    "vector_vector_KeyPoint": { "j_type" : "List<MatOfKeyPoint>", "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<KeyPoint> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<KeyPoint> > %(n)s", "csharpn_type" : "IntPtr"},
    "vector_vector_DMatch"  : { "j_type" : "List<MatOfDMatch>",   "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<DMatch> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<DMatch> > %(n)s" , "csharpn_type" : "IntPtr"},
    "vector_vector_char"    : { "j_type" : "List<MatOfByte>",     "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<char> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<char> > %(n)s", "csharpn_type" : "IntPtr"},
    "vector_vector_Point"   : { "j_type" : "List<MatOfPoint>",    "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<Point> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<Point> > %(n)s", "csharpn_type" : "IntPtr"},
    "vector_vector_Point2f" : { "j_type" : "List<MatOfPoint2f>",    "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<Point2f> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<Point2f> > %(n)s", "csharpn_type" : "IntPtr" },
    "vector_vector_Point3f" : { "j_type" : "List<MatOfPoint3f>",    "jn_type" : "long", "jni_type" : "jlong", "jni_var" : "std::vector< std::vector<Point3f> > %(n)s" , "csharp_type" : "void", "csharp_var" : "std::vector< std::vector<Point3f> > %(n)s" , "csharpn_type" : "IntPtr"},

    "Mat"     : { "j_type" : "Mat", "jn_type" : "long", "jn_args" : (("__int64", ".nativeObj"),),
                  "jni_var" : "Mat& %(n)s = *((Mat*)%(n)s_nativeObj)",
                  "jni_type" : "jlong", #"jni_name" : "*%(n)s",
                  "suffix" : "J" , "csharp_type" : "Mat*", "csharp_var" : "Mat& %(n)s = *((Mat*)%(n)s_nativeObj)", "csharpn_type" : "IntPtr"},

    "Point"   : { "j_type" : "Point", "jn_args" : (("double", ".x"), ("double", ".y")),
                  "jni_var" : "Point %(n)s((int)%(n)s_x, (int)%(n)s_y)", "jni_type" : "jdoubleArray",
                  "suffix" : "DD", "csharp_type" : "void","csharp_var" : "Point %(n)s((int)%(n)s_x, (int)%(n)s_y)"},
    "Point2f" : { "j_type" : "Point", "jn_args" : (("double", ".x"), ("double", ".y")),
                  "jni_var" : "Point2f %(n)s((float)%(n)s_x, (float)%(n)s_y)", "jni_type" : "jdoubleArray",
                  "suffix" : "DD", "csharp_type" : "void","csharp_var" : "Point2f %(n)s((float)%(n)s_x, (float)%(n)s_y)"},
    "Point2d" : { "j_type" : "Point", "jn_args" : (("double", ".x"), ("double", ".y")),
                  "jni_var" : "Point2d %(n)s(%(n)s_x, %(n)s_y)", "jni_type" : "jdoubleArray",
                  "suffix" : "DD", "csharp_type" : "void","csharp_var" : "Point2d %(n)s(%(n)s_x, %(n)s_y)"},
    "Point3i" : { "j_type" : "Point3", "jn_args" : (("double", ".x"), ("double", ".y"), ("double", ".z")),
                  ...
                  "suffix" : "DDD", "csharp_type" : "void", "csharp_var" : "Point3i %(n)s((int)%(n)s_x, (int)%(n)s_y, (int)%(n)s_z)"},
    "Point3f" : { "j_type" : "Point3", "jn_args" : (("double", ".x"), ("double", ".y"), ("double", ".z")),
                  ...
                  "suffix" : "DDD", "csharp_type" : "void", "csharp_var" : "Point3f %(n)s((float)%(n)s_x, (float)%(n)s_y, (float)%(n)s_z)"},
    "Point3d" : { "j_type" : "Point3", "jn_args" : (("double", ".x"), ("double", ".y"), ("double", ".z")),
                  "jni_var" : "Point3d %(n)s(%(n)s_x, %(n)s_y, %(n)s_z)", "jni_type" : "jdoubleArray",
                  "suffix" : "DDD", "csharp_type" : "void","csharp_var" : "Point3d %(n)s(%(n)s_x, %(n)s_y, %(n)s_z)"},
    "KeyPoint": { "j_type" : "KeyPoint", "jn_args" : (("float", ".x"), ("float", ".y"), ("float", ".size"),
                  ...
                  "suffix" : "FFFFFII", "csharp_type" : "void","csharp_var" : "KeyPoint %(n)s(%(n)s_x, %(n)s_y, %(n)s_size, %(n)s_angle, %(n)s_response, %(n)s_octave, %(n)s_class_id)"},
    "DMatch" :  { "j_type" : "DMatch", "jn_args" : ( ('int', 'queryIdx'), ('int', 'trainIdx'),
                  ...
                  "jni_type" : "jdoubleArray",
                  "suffix" : "IIIF", "csharp_type" : "void","csharp_var" : "DMatch %(n)s(%(n)s_queryIdx, %(n)s_trainIdx, %(n)s_imgIdx, %(n)s_distance)"},
    "Rect"    : { "j_type" : "Rect",  "jn_args" : (("int", ".x"), ("int", ".y"), ("int", ".width"), ("int", ".height")),
                  ...
                  "suffix" : "IIII", "csharp_type" : "void","csharp_var" : "Rect %(n)s(%(n)s_x, %(n)s_y, %(n)s_width, %(n)s_height)"},
    "Size"    : { "j_type" : "Size",  "jn_args" : (("double", ".width"), ("double", ".height")),
                  "jni_var" : "Size %(n)s((int)%(n)s_width, (int)%(n)s_height)", "jni_type" : "jdoubleArray",
                  "suffix" : "DD", "csharp_type" : "void", "csharp_var" : "Size %(n)s((int)%(n)s_width, (int)%(n)s_height)"},
    "Size2f"  : { "j_type" : "Size",  "jn_args" : (("double", ".width"), ("double", ".height")),
                  ...
                  "suffix" : "DD", "csharp_type" : "void","csharp_var" : "Size2f %(n)s((float)%(n)s_width, (float)%(n)s_height)"},
 "RotatedRect": { "j_type" : "RotatedRect",  "jn_args" : (("double", ".center.x"), ("double", ".center.y"), ("double", ".size.width"), ("double", ".size.height"), ("double", ".angle")),
                  ...
                  "jni_type" : "jdoubleArray", "suffix" : "DDDDD", "csharp_type" : "void","csharp_var" : "RotatedRect %(n)s(cv::Point2f(%(n)s_center_x, %(n)s_center_y), cv::Size2f(%(n)s_size_width, %(n)s_size_height), %(n)s_angle)"},
    "Scalar"  : { "j_type" : "Scalar",  "jn_args" : (("double", ".val[0]"), ("double", ".val[1]"), ("double", ".val[2]"), ("double", ".val[3]")),
                  ...
                  "suffix" : "DDDD", "csharp_type" : "void","csharp_var" : "Scalar %(n)s(%(n)s_val0, %(n)s_val1, %(n)s_val2, %(n)s_val3)"},
    "Range"   : { "j_type" : "Range",  "jn_args" : (("int", ".start"), ("int", ".end")),
                  "jni_var" : "Range %(n)s(%(n)s_start, %(n)s_end)", "jni_type" : "jdoubleArray",
                  "suffix" : "II", "csharp_type" : "void","csharp_var" : "Range %(n)s(%(n)s_start, %(n)s_end)"},
    ...
    "String"  : { "j_type" : "String",  "jn_type" : "String",
                  ...
                  "suffix" : "Ljava_lang_String_2", "csharp_type" : "const char* ","csharp_var" : 'const char* n_%(n)s = %(n)s', "csharpn_type" : "string"},
...
"TermCriteria": { "j_type" : "TermCriteria",  "jn_args" : (("int", ".type"), ("int", ".maxCount"), ("double", ".epsilon")),
                  ...
                  "suffix" : "IID", "csharp_type" : "void","csharp_var" : "TermCriteria %(n)s(%(n)s_type, %(n)s_maxCount, %(n)s_epsilon)", "jni_type" : "jdoubleArray"},
"CvTermCriteria": { "j_type" : "TermCriteria",  "jn_args" : (("int", ".type"), ("int", ".maxCount"), ("double", ".epsilon")),
    ...
    "Vec2d"   : { "j_type" : "double[]",  "jn_args" : (("double", ".val[0]"), ("double", ".val[1]")),
                  ...
                  "suffix" : "DD", "csharp_type" : "void","csharp_var" : "Vec2d %(n)s(%(n)s_val0, %(n)s_val1)", "csharpn_type" : "IntPtr"},
    "Vec3d"   : { "j_type" : "double[]",  "jn_args" : (("double", ".val[0]"), ("double", ".val[1]"), ("double", ".val[2]")),
                  ...
                  "suffix" : "DDD", "csharp_type" : "void","csharp_var" : "Vec3d %(n)s(%(n)s_val0, %(n)s_val1, %(n)s_val2)", "csharpn_type" : "IntPtr"},

}

# { class : { func : {j_code, jn_code, cpp_code, csharp_code, csharpn_code} } }
ManualFuncs = {
    'Core' :
    {
        'minMaxLoc' : {
...
##            {'j_code' : '/* TBD: checkRange() */', 'jn_code' : '', 'cpp_code' : '' },
    ...
    'Highgui' :
    {
        "namedWindow"       : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "destroyWindow"     : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "destroyAllWindows" : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "startWindowThread" : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "setWindowProperty" : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "getWindowProperty" : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "getTrackbarPos"    : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "setTrackbarPos"    : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "imshow"            : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "waitKey"           : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "moveWindow"        : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
        "resizeWindow"      : {'j_code' : '', 'jn_code' : '', 'cpp_code' : '', 'csharp_code' : '', 'csharpn_code' : '' },
    }, # Highgui
}
...
// C++: class $name
//javadoc: $name
public class $jname : DisposableOpenCVObject {
...
class ClassInfo(GeneralInfo):
    def __init__(self, decl, namespaces=[]): # [ 'class/struct cname', ': base', [modlist] ]
        ...
        self.csharp_code = None # cpp code stream
        self.csharpn_code = None
    ...
    def initCodeStreams(self, Module):
        ...
        self.csharp_code = StringIO()
        self.csharpn_code = StringIO();
        if self.name != Module:
            self.csharp_code.write(T_CSHARP_START_INHERITED if self.base else T_CSHARP_START_ORPHAN)
            self.j_code.write(T_JAVA_START_INHERITED if self.base else T_JAVA_START_ORPHAN)
        else:
            self.j_code.write(T_JAVA_START_MODULE)
            self.csharp_code.write(T_CSHARP_START_MODULE)
        # misc handling
        if self.name == 'Core':
            self.imports.add("java.lang.String")
            self.j_code.write(libVersionBlock())
            self.csharp_code.write(libVersionBlock())

    def cleanupCodeStreams(self):
        self.j_code.close()
        self.jn_code.close()
        self.cpp_code.close()
        self.csharp_code.close()
        self.csharpn_code.close()
...
class JavaWrapperGenerator(object):
    ...
    def add_class(self, decl):
        ...
        type_dict[name] = \
            { "j_type" : classinfo.jname,
              ...
              "suffix" : "J" , "csharp_type" : classinfo.fullName(isCPP=True) + "*"}
        type_dict[name+'*'] = \
            { "j_type" : classinfo.jname,
              "jn_type" : "long", "jn_args" : (("__int64", ".nativeObj"),),
              "jni_name" : "("+classinfo.fullName(isCPP=True)+"*)%(n)s_nativeObj", "jni_type" : "jlong",
    ...
    def gen(self, srcfiles, module, output_path):
        ...
        for ci in self.classes.values():
            ...
            classCSharpCode = ci.generateCSharpCode(self.module, self.Module)
            self.save("%s/%s+%s.java" % (output_path, module, ci.jname), classJavaCode)
            self.save("%s/%s+%s.cs" % (output_path, module, ci.jname), classCSharpCode)
    ...
    def gen_func(self, ci, fi, prop_name=''):
        ...
        csharp_code = ci.csharp_code
        csharpn_code = ci.csharpn_code
        ...
        while True:
            ...
            for a in args:
                ...
                if "vector" in a.ctype: # pass as Mat
                    ...
                    jni_args1.append ( ArgInfo([ "__int64", "%s_mat_nativeObj" % a.name, "", [], "" ]) )
                    c_prologue.append( type_dict[a.ctype]["jni_var"] % {"n" : a.name} + ";" )
                    c_prologue.append( "Mat& %(n)s_mat = *((Mat*)%(n)s_mat_nativeObj)" % {"n" : a.name} + ";" )
                    c_prologue1.append( type_dict[a.ctype]["csharp_var"] % {"n" : a.name} + ";" )
                    c_prologue1.append( "Mat& %(n)s_mat = *((Mat*)%(n)s_mat_nativeObj)" % {"n" : a.name} + ";" )
                    if "I" in a.out or not a.out:
                        ...
                        c_prologue1.append( "Mat_to_%(t)s( %(n)s_mat, %(n)s );" % {"n" : a.name, "t" : a.ctype} )
                    else:
                        if not type_dict[a.ctype]["j_type"].startswith("MatOf"):
                    ...
                    if "O" in a.out:
                        ...
                        c_epilogue1.append( "%(t)s_to_Mat( %(n)s, %(n)s_mat );" % {"n" : a.name, "t" : a.ctype} )
                else:
            ...
            { "j_type" : "long",
              ...
              "suffix" : "J" , "csharp_type" : fi.fullClass(isCPP=True)+"*", "csharpn_type" : "IntPtr", "csharp_var" : type_dict[fi.ctype].get("csharp_var", "double[]"),"jni_var" :  type_dict[fi.ctype].get("jn_var", "double[]")}
                    ...
                    if a.out and not self.isWrapped(a.ctype): # out arg, pass as double[]
                        ...
                        jni_args1.append ( ArgInfo([ "double[]", "%s_out" % a.name, "", [], "" ]) )
            ...
            csharpn_code.write('    [DllImport("opencv_java3", CallingConvention = CallingConvention.Cdecl)]\n');
            clazz1 = ci.jname
            csharpn_code.write( Template(\
                "    private static extern $type ${module}_${clazz1}_$fname($args);\n").substitute(\
                module = self.module, \
                clazz1 = clazz1.replace('_', '_1'), \
                type = type_dict[fi.ctype].get("csharpn_type", "double[]"), \
                fname = (fi.jname + '_' + str(suffix_counter)).replace('_', '_1'), \
                name = fi.jname + '_' + str(suffix_counter), \
                args = ", ".join(["%s %s" % (type_dict[a.ctype]["csharpn_type"], a.name.replace(".","_").replace("[","").replace("]","")) for a in jn_args])
            ) );	
...
"""
            ...
            csharp_code.write( Template(\
"""    public $static $j_type $j_name($j_args)
    {
        $prologue
        $ret_val${module}_${clazz1}_$fname($jn_args_call)$tail;
        $epilogue
        $ret
    }
...
"""
            ...
            if fi.ctype == "void":
                ...
                c_epilogue1.append("Mat* _retval_ = new Mat();")
                c_epilogue1.append(fi.ctype+"_to_Mat(_ret_val_vector_, *_retval_);")
            ...
            for a in args:
                ...
                if "vector" not in a.ctype :
                    ...
                    if a.out and "I" not in a.out and not self.isWrapped(a.ctype) and a.ctype:
                        ...
                        c_prologue1.append("%s %s;" % (a.ctype, a.name))
            ...
            if type_dict[fi.ctype]["jni_type"] == "jdoubleArray":
			    jni_args1.append( ArgInfo([ "double[]", "vals", "", [], "" ]) )
...
""" ).substitute( \
        ...
        args1  = ", ".join(["%s %s" % (type_dict[a.ctype].get("csharp_type"), a.name) for a in jni_args1]), \
